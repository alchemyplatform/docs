...
url: https://docs.alchemy.com/reference/mev-protection
slug: docs/reference/mev-protection
---

Alchemy's RPC endpoints now come with built-in MEV protection on supported chains. This feature helps prevent frontrunning, sandwich attacks, and other forms of transaction manipulation—no additional code changes or tooling required.
...
* [BNB Smart Chain (BSC)](../node/bnb-smart-chain/bnb-smart-chain-endpoints)
* [Base](../node/base/base-api-endpoints)
