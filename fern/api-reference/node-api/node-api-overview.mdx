...
* indexed speciality endpoints (ie. NFTs, Tokens, Transfers), use our [Data API](https://www.alchemy.com/docs/reference/data-api-overview).
...
* [Data API](https://www.alchemy.com/docs/reference/data-overview): for fast, enriched, indexed queries (ie. historical token balances)
* [Wallet API](https://www.alchemy.com/docs/wallets): for smart account flows (ie. account abstraction)
