...
* [`eth_call`](/reference/eth-call-polygon-zkevm) → doesn't support state override at the moment and pending block.
...
To start deploying on the zkEVM, check out the [Polygon zkEVM Quickstart Guide](/docs/polygon-zkevm).
