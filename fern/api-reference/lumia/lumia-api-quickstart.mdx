...
const lumia = defineChain({
  ...
  rpcUrls: {
    default: { http: ["https://lumia-prism.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"] },
  },
});

const client = createPublicClient({
  chain: lumia,
  transport: http("https://lumia-prism.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"),
});
```
</CodeGroup>
...
Check out the following tutorials to learn how to build on Lumia:

* [Lumia API Endpoints](/reference/lumia-api-endpoints)
