...
To use the [trace\_filter](/reference/trace-filter) method [sign up for Alchemy](https://dashboard.alchemy.com/signup) on the Growth tier, or [upgrade your account](https://dashboard.alchemyapi.io/settings/billing/?a=e8cafd6dd9).
