...
The `trace_call` method returns an array of traces. The structure of these traces is explained in [Types of Trace Actions and their Structure](https://alchemyenterprisegroup.readme.io/reference/what-are-evm-traces#types-of-trace-actions). Below you can find an example.
