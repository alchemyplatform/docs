...
const crossfi = defineChain({
  ...
  rpcUrls: {
    default: { http: ["https://crossfi-testnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"] },
  },
});

const client = createPublicClient({
  chain: crossfi,
  transport: http("https://crossfi-testnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"),
});
```
</CodeGroup>
...
Check out the following tutorials to learn how to build on CrossFi:

* [CrossFi API Endpoints](/reference/crossfi-api-endpoints)
