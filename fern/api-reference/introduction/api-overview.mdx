...
<CardGroup cols={3}>
  <Card title="Arbitrum Orbit" icon={<img src="https://static.alchemyapi.io/images/docs/api_icon3.svg" alt="Arbitrum Orbit logo" />} href="/docs/reference/supported-stacks">
    View the Arbitrum Orbit rollup framework.
  </Card>

  <Card title="OP Stack" icon={<img src="https://static.alchemyapi.io/images/docs/api_icon4.svg" alt="OP Stack logo" />} href="/docs/reference/supported-stacks">
