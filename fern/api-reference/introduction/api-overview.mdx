...
<CardGroup cols={3}>
  ...
  <Card title="Transfers API" icon="fa-solid fa-arrow-right-arrow-left" href="/reference/transfers-api-quickstart">
    Get historical transactions for any address in a single request.
  </Card>

  <Card title="Prices API" icon="fa-solid fa-chart-line" href="/reference/prices-api-quickstart">
