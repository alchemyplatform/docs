...
subtitle: The easiest way to connect your dApp to the blockchain and get the power of Alchemy's infrastructure. Just download, write two lines of code, and go.
...
[![GitHub - alchemyplatform/alchemy-sdk: The easiest way to connect your dApp to the blockchain.](alchemy-sdk.png)](https://github.com/alchemyplatform/alchemy-sdk)

[![github.com](favicon.ico)github.com](https://github.com/alchemyplatform/alchemy-sdk)

[GitHub - alchemyplatform/alchemy-sdk: The easiest way to connect your dApp to the blockchain.](https://github.com/alchemyplatform/alchemy-sdk)
...
<Warning>
  The public "demo" API key may be rate limited based on traffic. To create your own API key, **[sign up for an Alchemy account here](https://dashboard.alchemy.com/signup)** and use the key created on your dashboard for the first app.
</Warning>
...
<Info>
  To contribute to the Alchemy SDK, visit our [Github](https://github.com/alchemyplatform/alchemy-sdk) or click [here](https://github.com/alchemyplatform/aa-sdk/archive/refs/heads/main.zip) to download the files.
</Info>
