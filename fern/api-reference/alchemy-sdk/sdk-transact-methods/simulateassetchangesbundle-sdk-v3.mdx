...
subtitle: Simulates the asset changes resulting from a list of transactions simulated in sequence. Returns a list of asset changes for each transaction during simulation.
url: https://docs.alchemy.com/reference/simulateassetchangesbundle-sdk-v3
slug: reference/simulateassetchangesbundle-sdk-v3
---
...
| Property                                | Type               | Description                         |
| --------------------------------------- | ------------------ | ----------------------------------- |
| `Promise<SimulateAssetChangesResponse>` | `array of objects` | Returns the transactions' response. |

### `SimulateAssetChangesResponse` object parameters

| Property   | Type     | Description                                                                                                                                          |
| ---------- | -------- | ---------------------------------------------------------------------------------------------------------------------------------------------------- |
| `changes`  | `array`  | An array of asset changes resulted from the transaction.                                                                                             |
