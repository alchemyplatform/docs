...
url: https://docs.alchemy.com/reference/deletewebhook-sdk-v3
slug: reference/deletewebhook-sdk-v3
---
...
* **Updating webhook settings**: If you need to update the URL or other settings of a webhook, you can delete the existing webhook using the`deleteWebhook` method and then create a new one with the updated settings using `createWebhook`.
...
* [updateWebhook](/reference/updatewebhook-sdk) - Update a webhook address.
