...
subtitle: Simulates a single transaction and the resulting and returns list of decoded traces and logs that occurred during the transaction simulation.
url: https://docs.alchemy.com/reference/simulateexecution-sdk
slug: reference/simulateexecution-sdk
---
