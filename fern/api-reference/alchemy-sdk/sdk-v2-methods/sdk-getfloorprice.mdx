...
url: https://docs.alchemy.com/reference/sdk-getfloorprice
slug: reference/sdk-getfloorprice
---
...
| -------------------------------- | -------- | ---------------------------------------------------------------------------------------------------------------------- |
| `Promise<GetFloorPriceResponse>` | `object` | Name of the NFT marketplace where the collection is listed. Current marketplaces supported: **OpenSea**, **LooksRare** |
