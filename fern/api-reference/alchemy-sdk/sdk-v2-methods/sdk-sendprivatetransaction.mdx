...
url: https://docs.alchemy.com/reference/sdk-sendprivatetransaction
slug: reference/sdk-sendprivatetransaction
---
...
| ----------------- | -------- | --------------------------------- |
| `Promise<string>` | `string` | Returns the transaction response. |
