...
url: https://docs.alchemy.com/reference/estimategas-sdk-v3
slug: reference/estimategas-sdk-v3
---
...
| -------------------- | -------- | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| `Promise<BigNumber>` | `object` | Returns an estimate of the amount of gas that would be required to submit the transaction to the network. This is an estimate of the amount of gas required to submit the given transaction to the network. An example of the output is `{ "type": "BigNumber", "hex": "0x6d22" }`. |
