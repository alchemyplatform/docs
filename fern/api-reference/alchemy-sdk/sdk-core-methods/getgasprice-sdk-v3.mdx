...
url: "https://docs.alchemy.com/reference/getgasprice-sdk-v3"
slug: "reference/getgasprice-sdk-v3"
---
...
| -------------------- | -------- | ------------------------------------------------------------------ |
| `Promise<BigNumber>` | `object` | Returns an object with the `hex`: *string* and `type`: *BigNumber* |
