...
subtitle: Returns the number of transactions ever sent from the provided address, as of the provided block tag. This value is used as the nonce for the next transaction from the address sent to the network.
url: https://docs.alchemy.com/reference/gettransactioncount-sdk-v3
slug: reference/gettransactioncount-sdk-v3
---
