...
url: "https://docs.alchemy.com/reference/findcontractdeployer-sdk-v3"
slug: "reference/findcontractdeployer-sdk-v3"
---
...
* **Contract verification**: When a new contract is deployed on a blockchain, it is important to verify the identity of the deployer to ensure that a trusted source deployed the contract. By using the `findContractDeployer` method, developers can easily verify the deployer of a contract and ensure that the contract is legitimate.
