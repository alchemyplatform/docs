...
url: https://docs.alchemy.com/reference/arbitrum-nova-chain-api-quickstart
...
Well done! You've just made your first request to the Arbitrum Nova API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Arbitrum Nova Chain](/reference/arbitrum-nova-api-endpoints) and start building your dApps on it!
