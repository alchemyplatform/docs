...
Well done! You've just made your first request to the Linea Chain API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Linea Chain](/reference/linea-api-endpoints) and start building your dApps on it!
