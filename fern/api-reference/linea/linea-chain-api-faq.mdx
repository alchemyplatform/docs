...
Explained in [Linea Chain API Quickstart](/reference/linea-api-quickstart).
...
You can find the list of all the methods Alchemy supports for the Linea Chain API on [Linea Chain API Endpoints](/reference/linea-api-endpoints) page.
