...
const citreaTestnet = defineChain({
  ...
  rpcUrls: {
    default: { http: ["https://citrea-testnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"] },
  },
});

const client = createPublicClient({
  chain: citreaTestnet,
  transport: http("https://citrea-testnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"),
});
```
</CodeGroup>
...
Check out the following tutorials to learn how to build on Citrea:

* [Citrea API Endpoints](/reference/citrea-api-endpoints)
