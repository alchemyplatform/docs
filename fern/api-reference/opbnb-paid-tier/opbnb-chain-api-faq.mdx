...
No, opBNB is only available on paid tiers (growth, scale, enterprise). If you're on free tier [upgrade](https://dashboard.alchemy.com/signup) your account to use opBNB. If you want Alchemy to support opBNB on free tier, please [request here](https://alchemyapi.typeform.com/to/F0SJX6RU).
