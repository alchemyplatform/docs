...
**Note**: This is rarely used in streaming contexts since you need to know the signature in advance. It is recommended to subscribe to the signature before sending the transaction.
