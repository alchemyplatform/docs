...
To access `v0_6` you can use the following URLs to make requests:

* Mainnet
  * `https://starknet-mainnet.g.alchemy.com/starknet/version/rpc/v0_6/{apiKey}`
* Testnet
  * `https://starknet-sepolia.g.alchemy.com/starknet/version/rpc/v0_6/{apiKey}`

To access `v0_7` (**notice the underscore**) you can use the following URLs to make requests:

* Mainnet
  * `https://starknet-mainnet.g.alchemy.com/starknet/version/rpc/v0_7/{apiKey}`
* Testnet
  * `https://starknet-sepolia.g.alchemy.com/starknet/version/rpc/v0_7/{apiKey}`

To access `v0_8` (**notice the underscore**) you can use the following URLs to make requests:

* Mainnet
  * `https://starknet-mainnet.g.alchemy.com/starknet/version/rpc/v0_8/{apiKey}`
* Testnet
  * `https://starknet-sepolia.g.alchemy.com/starknet/version/rpc/v0_8/{apiKey}`
