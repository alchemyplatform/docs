...
Explained in the [Optimism API Quickstart Guide](/reference/op-mainnet-api-quickstart##getting-started-instructions)
...
Before you get started, [update your Optimism RPC URL to Alchemy](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-optimism-to-metamask).
