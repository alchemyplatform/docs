...
<Tip title="Don’t have an API key?" icon="star">
  Sign up to start building on Solana. [Get started for free](https://alchemy.com/solana/?a=fb3149785d)
</Tip>
...
For this guide, we will be using npm or yarn as our package manager to install the required packages.
