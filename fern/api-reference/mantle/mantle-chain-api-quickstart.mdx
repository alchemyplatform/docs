...
Well done! You've just made your first request to the Mantle Chain API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Mantle Chain](/reference/mantle-api-endpoints) and start building your dApps on it!
