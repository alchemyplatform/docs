...
Explained in [Mantle Chain API Quickstart](/reference/mantle-api-quickstart).
...
You can find the list of all the methods Alchemy supports for the Mantle Chain API on [Mantle Chain API Endpoints](/reference/mantle-api-endpoints) page.
