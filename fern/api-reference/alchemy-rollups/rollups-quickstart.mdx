...
<CardGroup cols={3}>
  <Card title="Arbitrum Chain" icon={<img src="https://alchemyapi-res.cloudinary.com/image/upload/v1764179954/docs/api-reference/alchemy-rollups/api_icon3.svg" alt="Arbitrum Chain logo"/>} href="/reference/supported-stacks">
    View Arbitrum Chain rollup framework.
  </Card>
