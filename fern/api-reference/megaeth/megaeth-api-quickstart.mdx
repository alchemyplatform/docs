...
const megaETH = defineChain({
  ...
  rpcUrls: {
    default: { http: ["https://megaeth-mainnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"] },
  },
});

const client = createPublicClient({
  chain: megaETH,
  transport: http("https://megaeth-mainnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"),
});
```
</CodeGroup>
...
Check out the following tutorials to learn how to build on MegaETH:

* [MegaETH API Endpoints](/reference/megaeth-api-endpoints)
