...
Explained in [Scroll Chain API Quickstart](/reference/scroll-api-quickstart).
...
You can find the list of all the methods Alchemy supports for the Scroll Chain API on [Scroll Chain API Endpoints](/reference/scroll-api-endpoints) page.
