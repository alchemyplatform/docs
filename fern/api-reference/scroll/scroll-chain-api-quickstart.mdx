...
Well done! You've just made your first request to the Scroll Chain API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Scroll Chain](/reference/scroll-api-endpoints) and start building your dApps on it!
