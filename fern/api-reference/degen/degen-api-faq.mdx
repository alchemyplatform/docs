...
url: https://docs.alchemy.com/reference/degen-api-faq
slug: reference/degen-api-faq
---

## What is Degen?
Degen Chain is an Arbitrum Orbit–based Layer-3 that settles on Base and uses DEGEN as gas, delivering ultra-low-cost transactions for Farcaster mini-apps and trading-style apps.

## How do I get started with Degen?
Check out our [Degen API Quickstart guide](./degen-api-quickstart) to get started building on Degen.
