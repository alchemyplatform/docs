...
url: https://docs.alchemy.com/reference/botanix-api-faq
...
Check out our [Botanix API Quickstart guide](./botanix-api-quickstart) to get started building on Botanix.
