...
url: https://docs.alchemy.com/reference/botanix-api-quickstart
slug: reference/botanix-api-quickstart
---

*To use the Botanix API you'll need to [create a free Alchemy account](https://dashboard.alchemy.com/) first!*
