...
const stableTestnet = defineChain({
  ...
  rpcUrls: {
    default: { http: ["https://stable-testnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"] },
  },
});

const client = createPublicClient({
  chain: stableTestnet,
  transport: http("https://stable-testnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"),
});
```
</CodeGroup>
...
Check out the following tutorials to learn how to build on Stable:

* [Stable API Endpoints](/reference/stable-api-endpoints)
