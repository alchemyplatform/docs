...
<CodeGroup>
  ```bash bash npm install axios # Or with yarn # yarn add axios ```
</CodeGroup>

Next, create an `index.js` file in your project directory. Paste the following code to send a request to the Bitcoin network:
...
Well done! You've just made your first request to the Bitcoin App API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Bitcoin App](/reference/bitcoin/bitcoin-api-endpoints) and start building your dApps on it!
