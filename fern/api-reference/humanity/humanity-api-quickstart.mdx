...
const humanity = defineChain({
  ...
  rpcUrls: {
    default: { http: ["https://humanity-mainnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"] },
  },
});

const client = createPublicClient({
  chain: humanity,
  transport: http("https://humanity-mainnet.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"),
});
```
</CodeGroup>
...
Check out the following tutorials to learn how to build on Humanity:

* [Humanity API Endpoints](/reference/humanity-api-endpoints)
