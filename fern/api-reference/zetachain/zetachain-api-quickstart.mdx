...
*To use the ZetaChain API you'll need to [create a free Alchemy account](https://dashboard.alchemy.com/signup) first. Also, we're offering up to $20,000 to help you start building. It's easy to qualify. Learn more [here](https://www.alchemy.com/summer-of-chains-build-and-save)!*
