...
const client = createPublicClient({
  ...
  transport: http("https://unichain-sepolia.g.alchemy.com/v2/YOUR_ALCHEMY_API_KEY"),
});
```
</CodeGroup>
...
Check out the following tutorials to learn how to build on Unichain:

* [Unichain API Endpoints](/reference/unichain-api-endpoints)
