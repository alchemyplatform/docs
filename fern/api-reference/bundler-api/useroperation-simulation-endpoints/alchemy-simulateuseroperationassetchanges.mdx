...
<Warning>
  This endpoint requires a dummy signature in the `userOp`. Check our [FAQs](/reference/bundler-faqs#what-is-a-dummy-signature) to learn what a dummy signature is.
</Warning>
