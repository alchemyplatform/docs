...
Using Alchemy’s [Subscription API](https://alchemyenterprisegroup.readme.io/reference/subscription-api), there are five main types of WebSocket subscriptions you can make to receive push updates to an Ethereum node: ​
...
If you’re interested in getting pushed updates on the state of the Ethereum network and avoiding HTTP workaround strategies such as [long polling](https://www.educative.io/edpresso/what-is-http-long-polling), start using [WebSockets today](https://alchemyenterprisegroup.readme.io/reference/subscription-api) to streamline your request workflow!
