...
* `includeRemoved` (optional): `boolean` specifier to include transactions that have been removed from the cannonical chain (or [re-orged](/docs/ethereum-developer-guide-to-the-merge#what-is-a-re-org-re-organization)).
