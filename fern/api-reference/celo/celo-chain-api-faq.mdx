...
Developers should use the Celo Alfajores testnet for Celo. This testnet provides an environment to deploy and test applications. Tokens can be obtained from the [Celo Alfajores Faucet](https://faucet.celo.org/alfajores).
