...
Explained in [Celo Chain API Quickstart](/reference/celo-api-quickstart).
...
You can find the list of all the methods Alchemy supports for the Celo Chain API on [Celo Chain API Endpoints](/reference/celo-api-endpoints) page.
