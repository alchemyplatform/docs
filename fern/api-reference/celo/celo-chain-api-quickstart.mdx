...
url: https://docs.alchemy.com/reference/celo-api-quickstart
...
Well done! You've just made your first request to the Celo Chain API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Celo Chain](/reference/celo-api-endpoints) and start building your dApps on it!
