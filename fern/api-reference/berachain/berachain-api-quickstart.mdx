...
url: https://docs.alchemy.com/reference/berachain-api-quickstart
slug: reference/berachain-api-quickstart
---

*To use the Berachain App API you'll need to [create a free Alchemy account](https://dashboard.alchemy.com/signup/?utm_source=docs\&utm_medium=website\&utm_campaign=berachain) first!*
