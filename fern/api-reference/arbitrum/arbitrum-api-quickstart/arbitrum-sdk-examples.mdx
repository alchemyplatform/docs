---
title: Arbitrum SDK Examples
description: Real-world examples on how to query information from Arbitrum using the most powerful Web3 SDK.
subtitle: Real-world examples on how to query information from Arbitrum using the most powerful Web3 SDK.
url: https://docs.alchemy.com/reference/arbitrum-sdk-examples
...
An eth\_call in Arbitrum is essentially a way to execute a message call immediately without creating a transaction on the block chain. It can be used to query internal contract state, to execute validations coded into a contract or even to test what the effect of a transaction would be without running it live.
