...
Explained in [Metis Chain API Quickstart](/reference/metis-api-quickstart).
...
You can find the list of all the methods Alchemy supports for the Metis Chain API on [Metis Chain API Endpoints](/reference/metis-api-endpoints) page.
