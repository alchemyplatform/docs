...
Well done! You've just made your first request to the Metis Chain API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Metis Chain](/reference/metis-api-endpoints) and start building your dApps on it!
