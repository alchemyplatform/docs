---
title: Hyperliquid API Quickstart
description: How to get started building on Hyperliquid using Alchemy
subtitle: How to get started building on Hyperliquid using Alchemy
slug: docs/hyperliquid
---
...
Let's use the [`viem`](https://www.npmjs.com/package/viem) package to create a Hyperliquid client connected to Alchemy and fetch the latest block number!
...
Check out the following tutorials to learn how to build on Hyperliquid:

* [Hyperliquid API Endpoints](/reference/hyperliquid-api-endpoints)
