...
Using the Alchemy NFT API lets you fetch and display NFTs for your users, making it easy to build all kinds of NFT projects. For a list of copy-able scripts that use the NFT API to fetch NFT data, check out the [Recipes](/recipes) hub!
...
[![github.com](favicon.ico)github.com](https://github.com/alchemyplatform/nft-api-javascript-scripts)

[GitHub - alchemyplatform/nft-api-javascript-scripts: A collection of Javascript scripts running with Alchemy Web3.js, Fetch, or Axios](https://github.com/alchemyplatform/nft-api-javascript-scripts)
...
Alchemy is actively working on adding support for as many blockchains / NFT standards as we can. To influence our roadmap and let your voice be heard, please upvote or add requests on our public [feedback tracker](https://roadmap.alchemy.com/b/feature-requests/).

<Info>
  If you find that NFTs are missing in wallets you are calling, please provide details about the missing NFT [here](https://roadmap.alchemy.com/b/feature-requests/master-post-missing-nfts-in-wallet/) so we can get this resolved for you!
</Info>
...
We're actively working on expanding coverage of Alchemy-hosted NFT endpoints. Feel free to reach out to [\[email protected\]](/cdn-cgi/l/email-protection#c3b0b6b3b3acb1b783a2afa0aba6aebaeda0acae) for specific questions!
