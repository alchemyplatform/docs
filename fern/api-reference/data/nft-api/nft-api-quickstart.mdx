...
For this guide, we will be using `npm` or `yarn` as our package manager if you choose to use `axios`. The simple fetch option requires no additional dependencies with Node.js 18+.
