...
**—deploy-key** (Required): API deploy key that you can access from your [Subgraph Dashboard](https://dashboard.alchemy.com/signup) through the Add Subgraph button or the top of any subgraph's page.
