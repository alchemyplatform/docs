...
<Info>
  If you want to turn this off and only receive webhooks for non-empty queries, check out instructions in the [next FAQ question](https://alchemyenterprisegroup.readme.io/reference/custom-webhooks-faq#how-do-i-receive-webhooks-for-only-non-empty-results-ie-turn-off-the-heartbeat-mechanism-described-abovedont-receive-a-webhook-for-every-block)!
</Info>
