...
1. Navigate to the [Webhooks page](https://dashboard.alchemy.com/webhooks) in your Alchemy Dashboard.
...
Use the `create-webhook` endpoint: [/docs/reference/create-webhook](/reference/create-webhook).
