...
subtitle: "Frequently asked questions about the Notify API"
...
For Address Activity webhooks, we reliably support up to 100,000 addresses per single webhook. For Custom webhooks, with [variables](/reference/custom-webhook-variables), we support a maximum of 10M addresses.
