...
3. Navigate to your [webhooks dashboard](https://dashboard.alchemy.com/signup).
...
The Auth Token, located at the top of you [webhooks dashboard](https://dashboard.alchemy.com/signup), is required to let you manage your webhooks via our webhooks API!
