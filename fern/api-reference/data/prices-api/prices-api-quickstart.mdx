...
The [Alchemy SDK](https://github.com/alchemyplatform/alchemy-sdk) provides a convenient and fully featured way to interact with Alchemy’s APIs, including the Prices API.
