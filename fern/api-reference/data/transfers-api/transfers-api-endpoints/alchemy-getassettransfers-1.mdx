...
subtitle: "The Transfers API allows you to easily fetch historical transactions for any address across Ethereum and supported L2s including Polygon, Arbitrum, and Optimism."
url: "https://docs.alchemy.com/reference/alchemy-getassettransfers-1"
slug: "reference/alchemy-getassettransfers-1"
---
