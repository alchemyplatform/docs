...
The Data API gives you fast, reliable access to blockchain data without running your own indexing infrastructure. Whether you're building wallets, NFT platforms, analytics dashboards, or DeFi apps, the Data API saves you time and engineering costs by offering pre-transformed, production-ready data.
...
<CardGroup cols={3}>
  ...
  <Card title="Token API" icon="fa-solid fa-coins" href="/reference/token-api-quickstart">
  ...
  <Card title="Utility API" icon="fa-solid fa-screwdriver-wrench" href="/reference/utility-api-overview">
    Enhanced APIs to get blocks by timestamp and transaction receipts.
  </Card>

  <Card title="Subgraphs" icon="fa-solid fa-diagram-project" href="/reference/subgraphs-overview">
    Open-source tooling for building custom GraphQL APIs with blockchain data.
  </Card>
</CardGroup>
