...
<CardGroup cols={3}>
  ...
  <Card title="Prices API" icon={<img src="https://static.alchemyapi.io/images/docs/right_arow.svg" alt="Prices API logo"/>} href="/reference/prices-api-quickstart">
  ...
  <Card title="Utility API" icon={<img src="https://static.alchemyapi.io/images/docs/right_arow.svg" alt="Transact API logo"/>} href="/reference/utility-api-overview">
    Enhanced APIs to get blocks by timestamp and transaction receipts.
  </Card>

  <Card title="Subgraphs" icon={<img src="https://static.alchemyapi.io/images/docs/right_arow.svg" alt="Transact API logo"/>} href="/reference/subgraphs-overview">
