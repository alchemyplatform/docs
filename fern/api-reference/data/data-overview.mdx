...
<CardGroup cols={3}>
  ...
  <Card title="Utility API" icon={<img src="https://static.alchemyapi.io/images/docs/right_arow.svg" alt="Transact API logo"/>} href="https://www.alchemy.com/docs/data/utility-apis/transactions-receipts-endpoints/alchemy-get-transaction-receipts">
