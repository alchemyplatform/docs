...
<CardGroup cols={2}>
  <Card title="Using SDK" href="/wallets/smart-wallet-quickstart/sdk" icon="code">
    Start building in minutes using the TypeScript SDK.
  </Card>

  <Card title="Using JSON-RPC API" href="/wallets/smart-wallet-quickstart/api" icon="network-wired">
