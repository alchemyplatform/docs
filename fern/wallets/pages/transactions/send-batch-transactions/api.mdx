...
```
  ...
  <Step title="Sign & Send">
    Sign the returned signature request and send using `wallet_sendPreparedCalls`. See [Send Transactions](/wallets/transactions/send-transactions) for a complete example including handling first-time 7702 authorization.
  </Step>
</Steps>
