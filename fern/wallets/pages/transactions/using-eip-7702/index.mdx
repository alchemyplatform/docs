...
<Accordion title="Using non-7702 Smart Contract Accounts (SCA mode)">
  ...
  * Backwards compatibility with existing Smart Contract Accounts is required
  * Using chains that don't yet support EIP-7702
  * Using a signer (EOA or embedded wallet) that doesn't support signing EIP-7702 authorizations
  * You have specific requirements for smart contract account architecture
</Accordion>
