...
<CardGroup cols={2}>
  <Card title="Multi-chain setup" icon="link" href="/wallets/recipes/multi-chain-setup#other-javascript">
    Learn how to configure your app to work with multiple blockchain networks.
  </Card>

  <Card title="Server-side rendering" icon="server" href="/wallets/troubleshooting/ssr#other-javascript">
