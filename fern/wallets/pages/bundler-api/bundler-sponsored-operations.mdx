...
* **No Fee Estimation or Retries**: Eliminates the need for gas fee estimation, drop-and-replace logic, and retry mechanisms—set your max limit and the bundler handles the rest
