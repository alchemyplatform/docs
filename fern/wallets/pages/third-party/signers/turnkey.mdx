...
<Tabs>
  <Tab title="JavaScript" language="typescript">
    ...
    ```bash
    npm install @turnkey/sdk-server @turnkey/viem @alchemy/wallet-apis@0.0.0-alpha.19 viem
    # or
    yarn add @turnkey/sdk-server @turnkey/viem @alchemy/wallet-apis@0.0.0-alpha.19 viem
    # or
    pnpm add @turnkey/sdk-server @turnkey/viem @alchemy/wallet-apis@0.0.0-alpha.19 viem
    ```
    ...
    * **Server-Side**: This example uses Turnkey's `@turnkey/sdk-server` package which is designed for server environments. However, `@alchemy/wallet-apis` can be used in any JavaScript environment including browsers, React Native, and Node.js
  </Tab>
</Tabs>
