---
title: React Native Signer setup guide
...
2.  Create a **new account config** in your [Account Kit Dashboard](https://dashboard.alchemy.com/accounts)
    ...
    <img
      src="/account-kit/images/getting-started/apply-config-to-app.png"
    ...
    <br />
    <img
      src="/account-kit/images/getting-started/email-auth-setup.png"
    ...
    <br />
    <img
      src="/account-kit/images/getting-started/social-auth-setup-mobile.png"
...
3.  Create the config and copy the **API Key**
    <img
      src="/account-kit/images/getting-started/get-api-key.png"
