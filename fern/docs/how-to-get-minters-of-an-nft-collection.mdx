...
subtitle: >-
  Learn how to get the “day 1" minters of an NFT collection. The addresses that
  originally minted an NFT collection (first owners).
    ...
    <div class="wrapper_body_cmn_out">
        <div class="api_key_instruct_ban">
            ...
            <div class="api_key_instruct_ban_rtt">
                <a href="https://dashboard.alchemy.com/signup/?a=day-1-minters" class="gt_startd_vbtn">Get started for free</a>
            </div>
        </div>
    </div>
</body>
