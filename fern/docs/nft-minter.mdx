---
title: 'NFT Minter Tutorial: How to Create a Full Stack DApp'
subtitle: >-
  In this tutorial, you’ll build an NFT minter and learn how to create a
  full-stack dApp by connecting your smart contract to a React frontend using
  Metamask and Web3 tools.
slug: docs/nft-minter
---
...
<div class="video-embed-container">
  <iframe 
    class="embedly-embed" 
    src="//cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fwww.youtube.com%2Fembed%2FOVGoJV5tcM8%3Ffeature%3Doembed&display_name=YouTube&url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DOVGoJV5tcM8&image=https%3A%2F%2Fi.ytimg.com%2Fvi%2FOVGoJV5tcM8%2Fhqdefault.jpg&key=f2aa6fc3595946d0afc3d76cbbd25dc3&type=text%2Fhtml&schema=youtube" 
    width="854" 
    height="480" 
    scrolling="no" 
    title="NFT Minter Tutorial For Beginners (Javascript, React)" 
    frameborder="0" 
  ...
  <div class="video-info">
    <h3 class="video-title">
      <a href="https://www.youtube.com/watch?v=OVGoJV5tcM8" target="_blank">
        NFT Minter Tutorial For Beginners (Javascript, React)
      </a>
    </h3>
    <div class="video-source">
      <img src="https://www.youtube.com/s/desktop/5f84c3cd/img/favicon.ico" class="source-favicon" alt="YouTube favicon"></img>
...
<Info title = "Smart Contract Standards">
...
[Here's a link](https://goerli.etherscan.io/address/0x4C4a07F737Bf57F6632B6CAB089B78f62385aCaE) to the ERC-721 NFT smart contract we will be calling in this tutorial. If you'd like to learn how we made it, we highly recommend that you check out our other tutorial, ["How to Create an NFT."](/docs/how-to-create-an-nft)

<html lang="en">
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>Alchemy NFT Tutorial Link</title>
    <link rel="stylesheet" href="styles.css" />
</head>
<body>
    <div class="embed-container">
        <a href="https://docs.alchemy.com/alchemy/tutorials/how-to-create-an-nft" class="embed-link" target="_blank" rel="noopener noreferrer">
            <div class="embed-card">
                <div class="embed-image">
                    <img src="https://www.gitbook.com/cdn-cgi/image/height=640,width=1280,fit=contain,dpr=1,format=auto/https%3A%2F%2F3169887760-files.gitbook.io%2F~%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MB17w56kk7ZnRMWdqOL%252Fsocialpreview%252FAMk78lrzTEIIHSKefoey%252Falchemy-logo-blue-gradient.png%3Falt%3Dmedia%26token%3Dae77654d-ac15-44b9-8952-20e6769be385" alt="Alchemy NFT Tutorial" />
                </div>
                <div class="embed-content">
                    <div class="embed-title">How to Create an NFT Tutorial</div>
                    <div class="embed-url">docs.alchemy.com</div>
                </div>
                <div class="embed-favicon">
                    <img src="https://3169887760-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/spaces%2F-MB17w56kk7ZnRMWdqOL%2Favatar-1631043648701.png?generation=1631043649203081&alt=media" alt="Alchemy favicon" />
                    <span>docs.alchemy.com</span>
                </div>
            </div>
        </a>
    </div>
...
<Info title="Github: Clone Repository">
...
Next open your copy of `minter-starter-files`in to your favorite code editor (at Alchemy, wwe're big fans of [VSCode](https://code.visualstudio.com/download)), and then navigate into your `src` folder:

![2880](/images/3b2bc2f-RQXRr70mP174PjsKQI_jMKuq.png "RQXRr70mP174PjsKQI_jMKuq.png")
<div align="center" style="color: gray; font-style: italic;">We will work inside the "src" folder</div>
...
![2876](/images/32e01d7-PNrbdLnNM6OriGE32N25TGSl.png "PNrbdLnNM6OriGE32N25TGSl.png")
<div align="center" style="color: gray; font-style: italic;">What your UI should look like</div>
...
<Warning>
  NOTE: Make sure you're in the minter-starter-files folder and not the nft-minterfolder!
</Warning>
...
![796](/images/b1bf3a8-Screen_Shot_2022-09-22_at_1.28.09_PM.png "Screen Shot 2022-09-22 at 1.28.09 PM.png")
<div align="center" style="color: gray; font-style: italic;">Sample Metamask wallet</div>

### Add ether from a Faucet

In order to mint our NFTs (or sign any transactions on the Ethereum blockchain), we’ll need some fake Eth. To get Eth you can go to the [Goerli faucet](https://goerlifaucet.com/) and enter your Goerli account address, then click “Send Me Eth.” You should see Eth in your Metamask account soon after!

### Check your Balance[](step-5-check-your-balance)
...
<Info title="Window.Ethereum API">
...
### Add `connectWallet` function to your `Minter.js` UI Component[](import-connect-wallet-pressed-into-minter-jss-connect-wallet-function)
...
![946](https://files.readme.io/bf59749-test.gif "test.gif")
<div align="center" style="color: gray; font-style: italic;">The problem on page reload</div>
...
![2880](/images/e80d734-J-0NjUkj_6BObi1Q4Q3eRe6.png "J__0NjUkj_6BObi1Q4Q3eRe6.png")
<div align="center" style="color: gray; font-style: italic;">Create your Pinata API key</div>

You'll then be shown a popup with your API info. Make sure to put this somewhere safe.

![2880](/images/f1b2bc4-to1HORepBqC2D350oKtfQJlh.png "to1HORepBqC2D350oKtfQJlh.png")
<div align="center" style="color: gray; font-style: italic;">Make sure to save your API key and secret in a safe place</div>
...
<Check title="NFT Smart Contract">
  As we mentioned earlier, in this tutorial we will be using [this existing NFT smart contract](https://goerli.etherscan.io/address/0x4C4a07F737Bf57F6632B6CAB089B78f62385aCaE); however, if you'd like to learn how we made it, or make one yourself, we highly recommend you check out our other tutorial, ["**How to Create an NFT**."](https://docs.alchemyapi.com/alchemy/tutorials/how-to-create-an-nft)
</Check>
...
Once you’ve created an Alchemy account, you can generate an API key by creating an app. This will allow us to make requests to the Goerli test network.

Navigate to the “Create App” page in your Alchemy Dashboard by hovering over “Apps” in the nav bar and clicking “Create App”

![2880](/images/b8ca9d7-avF_wnWdWxL9X9YtBm8FO8bw.png "avF_wnWdWxL9X9YtBm8FO8bw.png")
<div align="center" style="color: gray; font-style: italic;">Create a new app</div>

Name your app (we chose "My First NFT!"), offer a short description, and choose “Goerli” for your network.

![2525](/images/f209c54-Screen_Shot_2022-10-04_at_3.53.24_PM.png "Screen Shot 2022-10-04 at 3.53.24 PM.png")
<div align="center" style="color: gray; font-style: italic;">Configure your app details</div>
...
![843](https://files.readme.io/1a7af71-mvmYwXa2U7TlurPx9Bqh2brD.gif "mvmYwXa2U7TlurPx9Bqh2brD.gif")
<div align="center" style="color: gray; font-style: italic;">Copy your Alchemy API key</div>
...
<head>
    <meta charset="UTF-8" />
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />
    <title>How to Build an NFT Website</title>
    <link rel="stylesheet" href="styles.css" />
</head>
<body>
    <div class="embed-container">
        <a href="https://docs.alchemy.com/alchemy/tutorials/nft-minter/how-do-i-deploy-nfts-online" class="embed-link" target="_blank" rel="noopener noreferrer">
            <div class="embed-card">
                <div class="embed-image">
                    <img src="https://www.gitbook.com/cdn-cgi/image/height=640,width=1280,fit=contain,dpr=1,format=auto/https%3A%2F%2F3169887760-files.gitbook.io%2F~%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MB17w56kk7ZnRMWdqOL%252Fsocialpreview%252FAMk78lrzTEIIHSKefoey%252Falchemy-logo-blue-gradient.png%3Falt%3Dmedia%26token%3Dae77654d-ac15-44b9-8952-20e6769be385" alt="How to Build an NFT Website" />
                </div>
                <div class="embed-content">
                    <div class="embed-title">How to Build an NFT Website</div>
                    <div class="embed-url">docs.alchemy.com</div>
                </div>
                <div class="embed-favicon">
                    <img src="https://3169887760-files.gitbook.io/~/files/v0/b/gitbook-legacy-files/o/spaces%2F-MB17w56kk7ZnRMWdqOL%2Favatar-1631043648701.png?generation=1631043649203081&alt=media" alt="Alchemy favicon" />
...
Presumably, you'd like to be able to show off the NFTs minted via your dApp in your wallet — so be sure to check out our quick tutorial [How to View Your NFT in Your Wallet](https://docs.alchemyapi.com/alchemy/tutorials/how-to-write-and-deploy-a-nft-smart-contract/how-to-view-your-nft-in-your-wallet)!
...
<div class="video-embed-container">
  <iframe
    class="embedly-embed"
    src="//cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fwww.youtube.com%2Fembed%2FmmrO6_5-hRU%3Ffeature%3Doembed&display_name=YouTube&url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DmmrO6_5-hRU&image=https%3A%2F%2Fi.ytimg.com%2Fvi%2FmmrO6_5-hRU%2Fhqdefault.jpg&key=f2aa6fc3595946d0afc3d76cbbd25dc3&type=text%2Fhtml&schema=youtube"
    width="640"
    height="480"
    scrolling="no"
    title="NFT Minter Tutorial Demo"
    frameborder="0"
    allow="autoplay; fullscreen"
    allowfullscreen="true">
  </iframe>
  <div class="video-info">
    <h3 class="video-title">
      <a href="https://www.youtube.com/watch?v=mmrO6_5-hRU&feature=youtu.be" target="_blank">
        NFT Minter Tutorial Demo
      </a>
    </h3>
    <div class="video-source">
...
<Info>
  The transactions sent through Metamask will use Metamask's default provider (not necessarily your Alchemy endpoint). If you'd like to send those transactions through Alchemy to unlock debugging tools and the [**Alchemy Notify** ](/docs/alchemy-notify)suite, check out [**this guide**](/docs/how-to-add-alchemy-rpc-endpoints-to-metamask) for connecting Metamask to Alchemy.
</Info>
