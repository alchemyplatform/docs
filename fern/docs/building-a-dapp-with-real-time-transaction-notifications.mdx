...
<Info title = "Alchemy Notify v1 vs v2">
...
<Info title = "Tutorial using mainnet or testnet">
...
<Info title = "Create Alchemy Account">
...
<div align="center" style="color: gray; font-style: italic;">Alchemy Notify API dashboard where web3 developers can create new webhooks.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Notify API dashboard showing how to create a new webhook based on address activity.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Alchemy address activity webhook interface with the chain, network, webhook URL, and Ethereum address filled in.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Where to find the webhook ID.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Where to find the Auth Key for the Alchemy Notify API.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Example Heroku deployment URL after the Heroku app was deployed.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Enable Ethereum and connect to MetaMask.</div>  
...
<div align="center" style="color: gray; font-style: italic;">A confirmation message that the Ethereum wallet address was added to notifications.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Example Ethereum address notification displayed in a dApp.</div>  
...
<Info title = "Environment Specifics">
...
<div align="center" style="color: gray; font-style: italic;">An example of a dApp with real-time transaction notifications.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Connecting the dApp frontend to MetaMask and selecting a wallet.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Confirmation message that notifications were enabled for the selected address.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Alchemy Dashboard with the Ethereum address listed underneath a webhook that monitors address activity.</div>  
...
<div align="center" style="color: gray; font-style: italic;">Example notification that is received when ETH was sent to a monitored Ethereum address.</div>  
