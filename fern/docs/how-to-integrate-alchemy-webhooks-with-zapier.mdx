...
![357](/images/d0ce06e-account_2.png "account 2.png") ![355](/images/47c8047-account_11.png "account 11.png")
...
![1600](/images/c1a2f45-pasted_image_0.png "pasted image 0.png")
<div align="center" style="color: gray; font-style: italic;">Alchemy's Goerli Faucet user interface where developers can get Goerli ETH to test smart contracts on the Goerli testnet.</div>
...
![1600](/images/1c41903-Screen_Shot_2022-04-30_at_7.14.47_PM.png "Screen Shot 2022-04-30 at 7.14.47 PM.png")
<div align="center" style="color: gray; font-style: italic;">Zapier user interface for creating a "Catch Hook" trigger to use with Alchemy's Notify API.</div>
...
![1600](/images/aa093e1-Screen_Shot_2022-05-02_at_1.50.30_PM_1.png "Screen Shot 2022-05-02 at 1.50.30 PM (1).png")
<div align="center" style="color: gray; font-style: italic;">Alchemy's dashboard for creating a new webhook for tracking address activity on the Goerli testnet.</div>
...
![1600](/images/db6f6e6-Screen_Shot_2022-05-12_at_1.32.09_PM.png "Screen Shot 2022-05-12 at 1.32.09 PM.png")
<div align="center" style="color: gray; font-style: italic;">Alchemy dashboard showing where to copy the Auth Token for the Notify API.</div>
...
![1600](/images/ef60712-Screen_Shot_2022-04-30_at_9.17.38_PM_1.png "Screen Shot 2022-04-30 at 9.17.38 PM (1).png")
<div align="center" style="color: gray; font-style: italic;">Zapier interface for continuing the automated action if the text matches the fromAddress.</div>
...
![1600](/images/6d52d31-Screen_Shot_2022-04-30_at_10.35.30_PM.png "Screen Shot 2022-04-30 at 10.35.30 PM.png")
<div align="center" style="color: gray; font-style: italic;">Send Email action interface on Zapier where developers can add the address activity to the email body copy.</div>
...
![1600](/images/5fcd08d-Screen_Shot_2022-04-30_at_10.46.48_PM.png "Screen Shot 2022-04-30 at 10.46.48 PM.png")
<div align="center" style="color: gray; font-style: italic;">Zapier action for finding a document in Firebase or Firestore.</div>
...
![1600](/images/32bd5a2-pasted_image_0.jpg "pasted image 0.jpg")
<div align="center" style="color: gray; font-style: italic;">Automated email sent using Zapier and Alchemy webhooks that notify receivers of new Ethereum address activity.</div>
...
![900](/images/86c7143-Screen_Shot_2022-05-01_at_1.54.40_AM.png "Screen Shot 2022-05-01 at 1.54.40 AM.png")
<div align="center" style="color: gray; font-style: italic;">Zapier interface for running javascript.</div>
...
![1446](/images/d638ead-Screen_Shot_2022-05-02_at_3.36.03_AM.png "Screen Shot 2022-05-02 at 3.36.03 AM.png")
<div align="center" style="color: gray; font-style: italic;">Zapier interfaces with email fields that have been replaced by a webhook response.</div>
...
![1600](/images/7dcf263-pasted_image_0_1.jpg "pasted image 0 (1).jpg")
<div align="center" style="color: gray; font-style: italic;">An automated email message sent after a tracked wallet address received ETH.</div>
