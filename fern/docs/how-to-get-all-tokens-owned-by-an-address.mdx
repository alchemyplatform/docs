...
<Card
title="Script to get all the tokens owned by an address"
iconPosition="center" 
href="https://alchemy-docs.readme.io/v1.0/recipes/script-to-get-all-the-tokens-owned-by-an-address"
slug = "script-to-get-all-the-tokens-owned-by-an-address">
Open Recipe >
</Card>
...
<div align="center">
  <img src="/images/52d3572-4225.png" alt="359" title="4225.png"/>
</div>
<div align="center" style="color: gray; font-style: italic;">Digital asset wallet interface that shows the token balances of multiple cryptocurrencies.</div>
...
<Info title = "The conversion of Token balances to human readable format">
