...
![Click on the Activity tab](/images/791e250-image.png)
<div align="center" style="color: gray; font-style: italic;">Click on the Activity tab</div>
...
![List of items](/images/fd65b37-image.png)
<div align="center" style="color: gray; font-style: italic;">List of items</div>

Click on any item. You can track Price History, Listings, and Offers.

![An item having the price history, listings, offers, etc.](/images/589205a-image.png)
<div align="center" style="color: gray; font-style: italic;">An item having the price history, listings, offers, etc.</div>

To track the price of the above NFT, click on the price history to see the current price.

![Average price and number of sales changes as the date changes](/images/3058cb9-image.png)
<div align="center" style="color: gray; font-style: italic;">Average price and number of sales changes as the date changes</div>

To track the listings of the above NFT, click on the listings.

![The listings of the item show the price, quantity, etc.](/images/959479f-image.png)
<div align="center" style="color: gray; font-style: italic;">The listings of the item show the price, quantity, etc.</div>

To track the offers of the above NFT, click on the offers.

![The current offers on the item consist of floor difference, price, etc.](/images/fb9ba9d-image.png)
<div align="center" style="color: gray; font-style: italic;">The current offers on the item consist of floor difference, price, etc.</div>

You can filter your NFTs by collection.

![Filter the item based on sales, listings, offers, and transfers](/images/3131641-image.png)
<div align="center" style="color: gray; font-style: italic;">Filter the item based on sales, listings, offers, and transfers</div>
...
![Search for the particular item and select it](/images/b565e9e-image.png)
<div align="center" style="color: gray; font-style: italic;">Search for the particular item and select it</div>

Click on the item, scroll down, and then click on the details.

![Details of the item’s contract address, token ID, etc.](/images/543766b-image.png)
<div align="center" style="color: gray; font-style: italic;">Details of the item’s contract address, token ID, etc.</div>
...
![Notify tab of the Alchemy Dashboard](/images/947b71f-image.png)
<div align="center" style="color: gray; font-style: italic;">Notify tab of the Alchemy Dashboard</div>
...
![Click on the Create Webhook button](/images/3ab1c20-image.png)
<div align="center" style="color: gray; font-style: italic;">Click on the Create Webhook button</div>
...
![Test the webhook after passing some inputs like addresses](/images/25c65a5-image.png)
<div align="center" style="color: gray; font-style: italic;">Test the webhook after passing some inputs like addresses</div>
...
![Select the item on the OpenSea platform](/images/9c4fea4-image.png)
<div align="center" style="color: gray; font-style: italic;">Select the item on the OpenSea platform</div>
...
![Open this item on the Etherscan](/images/6a92ad9-image.png)
<div align="center" style="color: gray; font-style: italic;">Open this item on the Etherscan</div>

Copy the collection contract address.

![Item opened on the Etherscan](/images/d857cf8-image.png)
<div align="center" style="color: gray; font-style: italic;">Item opened on the Etherscan</div>

Having copied the collection address, proceed to paste it into the designated address field, as illustrated below.

![Pass the Webhook URL, addresses](/images/854e197-image.png)
<div align="center" style="color: gray; font-style: italic;">Pass the Webhook URL, addresses</div>
...
![Copy the unique URL from the webhook site](/images/1350f22-image.png)
<div align="center" style="color: gray; font-style: italic;">Copy the unique URL from the webhook site</div>
...
Post request coming from the Alchemy dashboard](/images/f80c994-image.png)
<div align="center" style="color: gray; font-style: italic;">Post request coming from the Alchemy dashboard</div>
...
![The status of the webhook is Active](/images/b1e292b-image.png)
<div align="center" style="color: gray; font-style: italic;">The status of the webhook is Active</div>

You can see that there are multiple post requests for the transaction.

![Transaction post requests](/images/59b728d-image.png)
<div align="center" style="color: gray; font-style: italic;">Transaction post requests</div>
