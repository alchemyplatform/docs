...
subtitle: >-
  Ethers.js and web3.js are popular Ethereum Javascript libraries for JSON-RPC
  protocol interaction. Ethers.js is lightweight, well-tested, and ideal for new
  projects.
...
![flow](/images/divzjiip8/image/upload/v1670483981/alchemyu/Untitled_5.png)
