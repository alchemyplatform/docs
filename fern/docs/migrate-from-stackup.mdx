...
subtitle: >-
  We’re thrilled to support your migration to Alchemy! This guide will walk you
  through the process and any necessary changes to your setup, and highlight the
  benefits of using our stack.
...
![Note: these are a few selected companies. ](/images/b325bf517f1cb287720febe68af32241386fa79865ccece6c5cf3a490a6de42b-top_companies.png)
<div align="center" style="color: gray; font-style: italic;">Note: these are a few selected companies.</div>
...
![🙀 UI components COMING SOON!! It’s the last piece 🧩](/images/4680e632d4806238d8f56868a69f1b3e039a52141359b82660581e565f768b17-Account_kit.png)
<div align="center" style="color: gray; font-style: italic;">🙀 UI components COMING SOON!! It’s the last piece 🧩</div>  
...
![Alchemy Developer Platform - each box is one API or product you can rely on to build great blockchain apps.](/images/f55e40fac6f27ba35eda4fb0b6706bee304adc9e27461d35199502434e9ef2b8-dev_platform.png)
<div align="center" style="color: gray; font-style: italic;">Alchemy Developer Platform - each box is one API or product you can rely on to build great blockchain apps.</div>
...
![Create an Alchemy Account](/images/62f0803c246ed2a12df8b873ed2157becbdebf030287a997806dcaec624067b0-Alchemy_account.png)
...
<Info>
For additional chain support, reach out on [discord](https://discord.com/invite/alchemyplatform).
</Info>

You will now have an API key to use for sending requests.

![](/images/699f4257cf29a8ff742fadb59d2afd957b59dcbfe95a36f420685c7f5b6dbb0e-API_key.png)
...
![](/images/43946542339a39c1e888959149c2829fc2ccbb3c5b78902457adbae980836a64-Gas_Manager_policy.png)
...
1. Replace RPC URL: `https://api.stackup.sh/v1/node/api_key` → `https://eth-mainnet.g.alchemy.com/v2/alchemy_api_key`
   ...
   * Replace alchemy\_api\_key with the key from step 2 (from [app dashboard](https://dashboard.alchemy.com/apps))
...
2. Use updated endpoint for all bundler API endpoints
   ...
   * Add the additional alchemy method `rundler_maxPriorityFee` when estimating gas to set the priority fee
   ...
   | ----------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------ |
   | [eth\_sendUserOperation](https://docs.stackup.sh/reference/eth-senduseroperation)                                       | [eth\_sendUserOperation](/reference/eth-senduseroperation)               |
   | [eth\_estimateUserOperationGas](https://docs.stackup.sh/docs/erc-4337-bundler-rpc-methods#eth_estimateuseroperationgas) | [eth\_estimateUserOperationGas](/reference/eth-estimateuseroperationgas) |
   | [eth\_getUserOperationReceipt](https://docs.stackup.sh/reference/eth-getuseroperationreceipt)                           | [eth\_getUserOperationReceipt](/reference/eth-getuseroperationreceipt)   |
   | [eth\_getUserOperationByHash](https://docs.stackup.sh/reference/eth-getuseroperationbyhash)                             | [eth\_getUserOperationByHash](/reference/eth-getuseroperationbyhash)     |
   | [eth\_supportedEntryPoints](https://docs.stackup.sh/reference/eth-supportedentrypoints)                                 | [eth\_supportedEntryPoints](/reference/eth-supportedentrypoints)         |
   |                                                                                                                         | [rundler\_maxPriorityFeePerGas](/reference/rundler-maxpriorityfeepergas) |
...
2. Update RPC methods
   ...
   | ---------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
   | [pm\_sponsorUserOperation](https://docs.stackup.sh/reference/pm-sponsoruseroperation)    | [alchemy\_requestGasAndPaymasterAndData](/reference/alchemy-requestgasandpaymasteranddata) (recommended)                |
   | [pm\_accounts](https://docs.stackup.sh/docs/paymaster-api-rpc-methods#pm_accounts)       | [alchemy\_requestPaymasterAndData](/reference/alchemy-requestpaymasteranddata) (alternative if manually estimating gas) |
            ...
            "params": [
              {
                ...
                "userOperation": { // partial user operation
                  "sender": "sender",
                  "nonce": "nonce",
                  "initCode": "initCode",
                  "callData": "callData"
...
<Info title ="Using an SDK and not APIs?">
  Please reach out on [discord](https://discord.com/invite/alchemyplatform) for additional SDK migration support. See [Account Kit](https://accountkit.alchemy.com/) to use our SDK.
</Info>

<Info>
  For additional support, reach out on [discord](https://discord.com/invite/alchemyplatform).
</Info>
