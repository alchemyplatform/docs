...
subtitle: >-
  Step 2 in the "Smart Accounts From Scratch" Series: Let's build and deploy a
  Paymaster!
...
✅ **Task 2/4**: Does your `paymasterAndData` field start with the paymaster address?
...
✅ **Task 3/4**: Was the deposit on behalf of the paymaster successful? You can check with `balanceOf` method.
