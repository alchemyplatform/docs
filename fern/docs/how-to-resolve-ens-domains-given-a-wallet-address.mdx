...
<Card
title="Script to Resolve ENS Domains Given a Wallet Address"
iconPosition="center" 
href="https://docs.alchemy.com/v1.0/recipes/script-to-resolve-ens-domains-given-a-wallet-address" 
slug = "script-to-resolve-ens-domains-given-a-wallet-address">
Open Recipe >
</Card>
...
<Info title = "Looking to get an address from an ENS domain?">
...
<Info title = "How to Resolve a Wallet Address Domains Given an ENS">
