---
title: 10. How to Create a Decentralized Twitter with Lens Protocol
subtitle: >-
  There's been a lot of discussions lately about how much control social media
  giants like Facebook and Twitter have. Regardless of what your opinion on it
  is, I'd like to share an experiment with you that is super exciting.
slug: docs/how-to-create-a-decentralized-twitter-with-lens-protocol
---
...
![](/images/bef84b9-rtw3-yt-banner.png "rtw3-yt-banner.png")

(Video version coming soon!)

### Step 0. Take a tour of the Lens Protocol ecosystem

![715](/images/8aa056c-lens_protocol.png "lens_protocol.png")
...
![639](/images/82d2ec7-top_right.png "top_right.png")

You can check out Apps that are already being built by the community!

Here, I'll draw your attention:
...
[![albert | thatguyintech.eth on Twitter: "gm @TheRoadToWeb3SUPER EXCITED to announce a partnership with @LensProtocol 🎉Imagine building a decentralized Twitter - Lens lets you do just that. Thanks to the Lens team, RTW3 PoK NFT holders can NOW CLAIM PROFILE HANDLES! / Twitter"](/images/errors/logo46x38.png)](https://twitter.com/thatguyintech/status/1546561239756615680)
...
![1278](/images/818e04f-lensfrens.png "lensfrens.png")
...
![1281](/images/8cefd23-lenz.png "lenz.png")
...
![1170](/images/0449f13-Phaver.png "Phaver.png")

Phaver

* **Refract** - It's like Hacker News, except all the links and posts that are shared here are powered by Lens Protocol.

![932](/images/30229d2-Refract.png "Refract.png")

Refract

These apps are all built by different people, different teams, with different user experiences and product goals, but all the underlying data is the same, as if they all shared the same database and APIs.

How can that be?

Turns out, that a shared database and public API are exactly the fundamental ideas of Lens Protocol. That's why this technology has so much potential.
...
![1950](/images/62d675d-rtl.png "rtl.png")
...
Loading up [http://localhost:3000](http://localhost:3000) should give you a basic template page that looks like this:

![1278](/images/0db0905-next.js.png "next.js.png")
...
![](/images/ce8bb50-localhost.png "localhost.png")
...
![1281](/images/c1692a0-jouni.png "jouni.png")

Check out the `RecommendedProfiles` response in console, or on the developer docs
...
![](/images/e5da8e9-stani.lens.png "stani.lens.png")
...
![881](/images/5ca2381-garethLens.png "garethLens.png")

much better looking after styling with Tailwind CSS
...
![789](/images/16cdd1a-404.png "404.png")
...
For fetching individual profile info, let's create a GraphQL document as we did earlier for fetching the entire recommended profiles list:
...
![991](/images/e1a8ed7-vitto.png "vitto.png")

id: 0x9752

![968](/images/f7aa1da-albert.png "albert.png")
...
If all goes well, you should now be able to see posts populated under the profile card! 🎉

![](/images/1be65ab-nada.lens.png "nada.lens.png")
...
I highly recommend you take time out to explore the Lens Documentation, try out different endpoints, and read through the sample code hosted in this repo:

[![GitHub - aave/lens-api-examples: code examples of how to speak to the lens API](https://opengraph.githubassets.com/6c6e81496ecae96f1e0c8d87186fc5638b7aae77f7c0220b3fa374b393f5c5de/aave/lens-api-examples)](https://github.com/aave/lens-api-examples)

[![github.com](/images/favicon.ico)github.com](https://github.com/aave/lens-api-examples)

[GitHub - aave/lens-api-examples: code examples of how to speak to the lens API](https://github.com/aave/lens-api-examples)
...
* [Lit Protocol SDK and tutorial](https://litprotocol.notion.site/Decentralized-Unlockable-Content-21a2a1dadb4a4845a5a77ab2589069a0) - created by [Deb](https://twitter.com/deb_i_deb) @ Lit Protocol
...
Want the video version of this tutorial? Subscribe to [the Alchemy YouTube channel](https://www.youtube.com/c/AlchemyPlatform) and join our [Discord community](https://university.alchemy.com/discord) to find thousands of developers ready to help you out!
