...
subtitle: >-
  Learn how to access and use Alchemy's ChatGPT Plugin: a tool that converts
  natural language to API requests to read on-chain data.
slug: docs/alchemy-chatgpt-plugin
---

<Info>
Join the waitlist to access Alchemy's ChatGPT Plugin [here] (https://www.alchemy.com/alchemyai). 
</Info>
...
![](/images/e869938-image.png)

***

# How to access the Plugin?

<Info title = "Plugin is in Beta">
