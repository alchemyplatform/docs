...
subtitle: >-
  Blockchain consensus mechanisms are rules that a distributed and decentralized
  blockchain network follows to agree on what is considered valid.
...
![blockchain-nodes](/images/O7jloYu.jpg)
