---
title: Waht is Archive Data on Ethereum? 
subtitle: >-
...
1. [Sign up](https://alchemy.com/?a=archive-data-guide) for an account (it's free!) and create your first project.

2. [Create your Alchemy key](https://docs.alchemy.com/alchemy/introduction/getting-started). This is the URL endpoint for getting realtime and archive data.
