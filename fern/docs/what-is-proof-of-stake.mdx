...
subtitle: >-
  Proof of Stake in Ethereum requires validators to stake 32ETH instead of
  mining with electricity, resulting in a secure, scalable, and energy-efficient
  network. Block finality should be considered when requesting data.
...
* [The Ethereum Developer Guide to the Merge](/reference/ethereum-developer-guide-to-the-merge)
