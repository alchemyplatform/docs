---
title: >-
  How to create a Modular Smart Contract Account and send UserOps with Account
  Kit
subtitle: >-
  Learn how to create your own modular smart contract account and send user
  operations using the Alchemy Account Kit.
slug: >-
  docs/how-to-create-a-modular-smart-contract-account-and-send-userops-with-account-kit
---
...
<Warning title = "Failed to find transaction">
