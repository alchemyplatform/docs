...
subtitle: >-
  Smart contracts produce two artifacts: ABI (human-readable interface) and
  bytecode (machine-readable program) necessary for front-end tools to
  communicate with Ethereum computer.
