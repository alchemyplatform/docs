...
subtitle: >-
  Solidity structs create custom data types for record-keeping, combining with
  arrays and functions to add, retrieve, and update records. They can be
  protected by checking msg.sender.
...
![structures](/images/w/images/c/c2/Structure-gc58a04cb9_1280.jpg)
...
![zelda-navi-wait](https://media.giphy.com/media/U8o1ssggvfKAo/giphy.gif)
