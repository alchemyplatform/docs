...
subtitle: >-
  This two-part tutorial will explore two ways you can deterministically deploy
  a contract across multiple networks.
...
![](/images/b73aae0-Deterministic-deploy-graphic.png "Deterministic-deploy-graphic.png")
...
![3814](/images/4f3b3f5-Network-testing.PNG "Network-testing.PNG")
...
![](/images/afe16d7-MetaMask-create-account-set.png "MetaMask-create-account-set.png")

<Warning>
Once you add an account there is no way to remove it
</Warning>
...
![](/images/1bda270-import-SK-mm-set.png "import-SK-mm-set.png")
...
![](/images/1c7ac25-AlchemyDash-Add-to-Wallet.png "AlchemyDash-Add-to-Wallet.png")
...
![](/images/5e1ebf4-Mm-Step5.png "Mm-Step5.png")
...
![](/images/7743b43-Screenshot_2022-09-12_at_6.08.20_PM.png "Screenshot 2022-09-12 at 6.08.20 PM.png")
...
![](/images/7a483b6-mm-opt-set.png "mm-opt-set.png")
...
![](/images/9368b7f-mm-2-3.png "mm-2-3.png")
...
![](/images/1fec764-offset-nonce-set.png "offset-nonce-set.png")
...
<Check>
  ...
  - [Arbitrum Goerli](https://goerli-rollup-explorer.arbitrum.io)

  - [Optimism Goerli](https://optimistic.etherscan.io/)
</Check>
