...
subtitle: >-
  Step 1 in the "Smart Accounts From Scratch" Series: Let's execute a user
  operation!
slug: docs/1-execute-a-user-operation
---


<Info title = "Want a Video Walkthrough?">
...
In your codebase we recommend you start by installing these contracts: [https://github.com/eth-infinitism/account-abstraction](https://github.com/eth-infinitism/account-abstraction) (if you're using `npm` you can do `npm i @account-abstraction/[email protected]`).
...
<Warning title = "OpenZeppelin Contracts Dependency">
  Until [OpenZeppelin is included as a dependency](https://github.com/eth-infinitism/account-abstraction/pull/402) in this package, you'll need to install it as well. Again, with npm you can do like this: `npm i @openzeppelin/[email protected]`
</Warning>

<Warning title = "Large Contract Size">
...
<Info title = "How do you want your account to work?">
