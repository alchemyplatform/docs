...
subtitle: >-
  Build a serverless web3 data ingestion API in 10 minutes using AWS, DynamoDB,
  and Custom Webhooks.
...
![](/images/5639bfb-small-Untitled_Drawing-hackerdraw_5.png)
...
![AWS SAM Installation guide webpage](/images/9219b9a-small-Screenshot_2023-05-09_at_5.36.58_PM.png)
...
![](/images/104527b-small-Screenshot_2023-05-08_at_11.23.45_AM.png)
...
![](/images/f906a5f-small-Screenshot_2023-05-08_at_11.32.58_AM_1.png)
...
![](/images/7e3ff96-small-Screenshot_2023-05-08_at_12.19.42_PM.png)
...
![](/images/ba107ad-small-Screenshot_2023-05-10_at_23.27.34.png)
...
![](/images/44ebbbd-small-Screenshot_2023-05-10_at_23.28.44.png)
...
![](/images/15caa0d-small-Screenshot_2023-05-10_at_23.30.12.png)

Navigate to the AWS console and search for the “**API Gateway**” service.

![](/images/2d14ddc-small-Screenshot_2023-04-24_at_14.41.27.png)

Click on the newly created **API Gateway**:

![](/images/faecb3c-small-Screenshot_2023-04-24_at_14.41.50_2.png)

And navigate to **stages** > **Stage** using the left-hand side menu:

![](/images/9051d28-small-Screenshot_2023-04-24_at_14.42.59_1.png)
...
![](/images/8ef7c1e-small-Screenshot_2023-04-24_at_13.18.20.png)

Click on the “**Create webhook**” button to create a new webhook, and select the “**Blank template**”

![](/images/3b32f8c-small-Screenshot_2023-04-24_at_14.51.30.png)
...
![](/images/e0bd994-small-Screenshot_2023-04-24_at_14.54.20.png)

Then click on the **DynamoDB** instance we’ve created before using SAM:

![](/images/8d87656-small-Screenshot_2023-04-24_at_13.22.32.png)

Look for the “**Items summary**” section, and click on “**Get live item count**”:

![](/images/cf78a2a-small-Screenshot_2023-04-24_at_13.22.52.png)
...
![](/images/d5bf099-small-Screenshot_2023-04-24_at_14.57.50.png)
...
![](/images/a2137b6-small-Screenshot_2023-04-24_at_13.24.15.png)
...
![](/images/01e2777-small-Screenshot_2023-04-24_at_13.26.54.png)
...
![](/images/e848a41-small-Screenshot_2023-04-24_at_13.29.03.png)
...
![](/images/6fe0910-small-Screenshot_2023-04-24_at_13.29.57.png)

Paste the hash value copied before in the Path → \{hash} input box, and click on the blue **Test button**:

![](/images/717aa28-small-Screenshot_2023-04-24_at_13.30.22_1.png)
...
And once again, congratulations on completing this tutorial, you did amazing 🎉
