...
subtitle: >-
  In this guide, we will set up a simple  project structure, add a contract with
  a state variable and a function to modify it. We will then write a quick test
  to make sure the function modifies the  as expected - let's get to it!
...
![Hardhat](/images/divzjiip8/image/upload/v1671126973/alchemyu/Screen_Shot_2022-12-14_at_9.29.17_PM.png)
