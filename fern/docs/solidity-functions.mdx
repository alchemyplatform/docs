...
subtitle: >-
  Solidity functions use  keyword, can be  or , and have visibility levels: , ,
  , .
...
![fn-syntax](/images/divzjiip8/image/upload/v1671060100/alchemyu/Screen_Shot_2022-12-14_at_3.20.22_PM.png)
