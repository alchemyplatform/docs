...
subtitle: >-
  In this tutorial, we’ll be using Alchemy’s core API to resolve a user's
  address from an ENS Domain Name owned by the user.
slug: docs/how-to-resolve-ewallet-given-ens
---


<Info title = "How to Resolve ENS Domains Given a Wallet Address">
...
iconPosition="center" 
href="https://alchemy-docs.readme.io/v1.0/recipes/script-to-resolve-ens-domains-given-a-wallet-address" 
