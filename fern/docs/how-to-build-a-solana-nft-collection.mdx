...
subtitle: >-
  Follow this tutorial to learn the fastest way to mint a collection of Solana
  NFTs using Alchemy, Metaplex, Bundlr, Arweave, and Hashlips.
slug: docs/how-to-build-a-solana-nft-collection
---

<div class="video-embed-container">
  <iframe
    class="embedly-embed"
    src="//cdn.embedly.com/widgets/media.html?src=https%3A%2F%2Fwww.youtube.com%2Fembed%2FdpZ98NUg_W0%3Ffeature%3Doembed&display_name=YouTube&url=https%3A%2F%2Fwww.youtube.com%2Fwatch%3Fv%3DdpZ98NUg_W0&image=https%3A%2F%2Fi.ytimg.com%2Fvi%2FdpZ98NUg_W0%2Fhqdefault.jpg&key=f2aa6fc3595946d0afc3d76cbbd25dc3&type=text%2Fhtml&schema=youtube"
    width="854"
    height="480"
    scrolling="no"
    title="How to build a Solana NFT Collection (Metaplex, Alchemy, Hashlips)"
    frameborder="0"
  ...
  <div class="video-info">
    <h3 class="video-title">
      <a href="https://www.youtube.com/watch?v=dpZ98NUg_W0" target="_blank">
        How to build a Solana NFT Collection (Metaplex, Alchemy, Hashlips)
      </a>
    </h3>
...
The original co-authors of this post are Kristian ([@k\_quirapas](https://twitter.com/k_quirapas)) and Albert ([@thatguyintech](https://www.twitter.com/thatguyintech)). Go say hi to them if you found this post useful!
...
4. [Node](https://nodejs.org/en/)(v14.19.0) and [Yarn](https://yarnpkg.com/)
...
Here's what your frontend DApp will look like: ![Your DApp Website](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/dapp-website.png)

When you're done, you'll be able to mint your NFTs using any Solana wallet (i.e. Phantom) on the devnet via Alchemy's Solana RPC. ![Example Minted NFT](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/example-minted-nft-in-wallet.png)
...
![Output after generation](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/generation.png)

Upon running your command go to your `build` folder and there should be a folder for `images` and a folder for `json`.

![Build Folder](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/build.png)
...
![Build Folder Contents](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/build-result.png)
...
![Assets Folder Overview](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/assets-collection.png)
...
3. `sugar upload` to upload your images and metadata (JSON) files to the storage of your choice
4. `sugar launch` to launch your Candy Machine for NFT collection minting
5. `sugar verify` to verify uploaded data
6. `sugar show` to show the details of your launched Candy Machine
...
![create-config Sample Configuration](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/create-config.png)
...
![Candy Machine UI Repo](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/candy-machine-ui.png)
...
![Vercel Add New](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/add-new.png)
...
For `<your-api-key>` go and [follow these steps](/docs/alchemy-quickstart-guide) to get a Solana API key.

> Tip: Don't know where to find the Candy Machine Program ID? Use `sugar show` and copy Candy Machine ID.

![Vercel](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/vercel.png)

After configuring it's time to deploy and **view your site**!

![Deploying](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/deploy.png)

A webpage should open like the one below. Connect your wallet and try minting one to test your Candy Machine deployment.

![Connect Wallet](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/connect-wallet.png)
...
![Your DApp Website](/images/alchemyplatform/solana-nft-tutorial/master/.github/images/dapp-website.png)
