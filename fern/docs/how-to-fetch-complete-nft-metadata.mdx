...
subtitle: >-
  Learn how to get the metadata for an NFT and how it can be useful in building
  web3 dapps
    ...
    <div class="wrapper_body_cmn_out">
        <div class="api_key_instruct_ban">
            ...
            <div class="api_key_instruct_ban_rtt">
                <a href="https://dashboard.alchemy.com/signup/?a=fetch-complete-metadata" class="gt_startd_vbtn">Get started for free</a>
            </div>
        </div>
    </div>
</body>
...
![](/images/0af5f18-nft-metadata.png "nft-metadata.png")
...
![3000](/images/38ca71f-alch-app.png "alch-app.png")
...
If you have any questions or need further assistance, feel free to join [Alchemy's Discord](https://discord.com/invite/alchemyplatform) and engage with the community. Also, don't forget to follow Alchemy on Twitter [@AlchemyPlatform](https://twitter.com/AlchemyPlatform) for the latest updates and news ✨
