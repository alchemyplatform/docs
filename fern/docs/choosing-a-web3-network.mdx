...
subtitle: >-
  A detailed guide to choosing which network to deploy on for Ethereum, Layer 2s
  and Solana. Compares Layer 1 chains vs Layer 2 chains as well as Mainnet vs
...
<Info title="Public RPC Endpoints">
