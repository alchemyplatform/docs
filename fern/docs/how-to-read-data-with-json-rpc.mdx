...
subtitle: >-
  We use JSON-RPC to communicate with Ethereum. All nodes have a JSON-RPC
  interface for read requests. Signed JSON-RPC requests are needed for writing.
...
![build-this](/images/divzjiip8/image/upload/v1670367843/alchemyu/Screen_Shot_2022-12-06_at_3.03.59_PM.png)
...
![rest-api](/images/en/wiki/images/f/f1/Rest-API.png)
...
![json-rpc-figma](/images/divzjiip8/image/upload/v1670369945/alchemyu/Untitled_1.png)
...
![json-rpc-request](/images/divzjiip8/image/upload/v1670370933/alchemyu/Screen_Shot_2022-12-06_at_3.55.15_PM.png)
...
![json-rpc-response](/images/divzjiip8/image/upload/v1670371227/alchemyu/Screen_Shot_2022-12-06_at_4.00.23_PM.png)
