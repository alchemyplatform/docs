...
subtitle: >-
  Multi-signature contracts require multiple signatures for transactions,
  providing security against lost or compromised keys. Gnosis Safe is a
  multi-signature smart contract deployer on Ethereum.
...
![eoa](/images/divzjiip8/image/upload/v1672905020/alchemyu/Untitled_15.png)
...
![ms-wallet](/images/divzjiip8/image/upload/v1672906425/alchemyu/Untitled_17.png)
