...
While building historical queries into dApps has traditionally been complicated, time-consuming, and error-prone, the [Alchemy Transfers API](https://docs.alchemy.com/alchemy/enhanced-apis/transfers-api) allows for developers to query historical wallet activity, token transfers, and other account-driven transactions in a simple transaction.
...
![1136](/images/5d8eadf-image_7.png "image (7).png")
...
![640](/images/a036824-image_8.png "image (8).png")
...
![408](/images/7c67380-image_9.png "image (9).png")
...
![1173](/images/7613b3f-image_10.png "image (10).png")
...
Once you have an account, you are now able to use the [`alchemy_getAssetTransfers`](/reference/alchemy-getassettransfers) method which allows you to query asset transfers.
...
* `category`: `["external","token"]` are the [types of transfer events](/reference/alchemy-getassettransfers) we want to monitor
...
![580](/images/9a06adb-img_1.PNG "img (1).PNG")
...
![1881](/images/b6c4aaf-image_11.png "image (11).png")
...
Here, we use the Alchemy specific method [`alchemy_getAssetTransfers`](/reference/alchemy-getassettransfers) to get the total number of AKITA tokens burned by the Gitcoin contract.
...
![1881](/images/12f0f77-image_12.png "image (12).png")
