...
subtitle: >-
  Web3 development consists of leveraging resources that empower the development
  cycle and strengthen your toolkit for building decentralized applications
  (dApps). This article will introduce you to Ethers.js, a prominent set of
  tools that interact with the blockchain and accelerate your journey into
  building dApps.
