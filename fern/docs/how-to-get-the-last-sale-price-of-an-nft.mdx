...
subtitle: Learn how to get the last sale price of an NFT using Alchemy SDK
    ...
    <div class="wrapper_body_cmn_out">
        <div class="api_key_instruct_ban">
            <div class="api_key_instruct_ban_lft">
                ...
                <p>Start using this API for your app today</p>
            </div>
            <div class="api_key_instruct_ban_rtt">
                <a href="https://dashboard.alchemy.com/signup/" class="gt_startd_vbtn">Get started for free</a>
            </div>
        </div>
    </div>
</body>
...
![2190](/images/0c1a314-opensea-azuki-sales.png "opensea-azuki-sales.png")
<div align="center" style="color: gray; font-style: italic;">Opensea's interface showing the last sale prices for Azuki NFTs</div>
...
![702](/images/bb1de3b-selling-summary.png "selling-summary.png")
<div align="center" style="color: gray; font-style: italic;">The breakdown of Protocol Fee, Royalty Fee and Seller Fee for an NFT whose last sale price is 100 ETH</div>
...
![2706](/images/fa373f9-most-recent-sale.png "most-recent-sale.png")
