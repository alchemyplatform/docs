---
title: 1. 如何使用 Alchemy 开发 NFT 智能合约（ERC721)
subtitle: 了解如何构建 NFT 智能合约
slug: docs/how-to-develop-an-nft-smart-contract-erc721-with-alchemy-mandarin
---


> 本文是中文翻译，原文地址： [1. How to Develop an NFT Smart Contract (ERC721) with Alchemy](/docs/how-to-develop-an-nft-smart-contract-erc721-with-alchemy)
...
*你不会希望有人会从你部署到区块链的合约中，偷走所有珍贵的加密货币或 NFT。对吗？*
...
![985](/images/9e820fe-erc721.png)

点击左上角的 ERC721 按钮，选择要使用的 ERC 标准类型和你想写的合约类型：

![997](/images/828ee6a-Erc721_2.png)
...
![516](/images/7c6e435-Alh_set.png)

## 选择 NFT（ERC721）的功能

现在需要选择你想集成到智能合约中的功能，在*设置 (Settings)*之后，你会看到*功能 (Features)*，在那里你可以选择不同的模块功能，以包括在你的智能合约当中。

![258](/images/acaa48a-Miint.png)
...
![256](/images/d4a7d1d-Screenshot_2022-05-01_at_17.20.48.png)
...
现在你已经限制了 NFT 的最大供应量，是时候编译智能合约并部署到 Goerli 测试网了。要做到这一点，你需要**在 [Alchemy.com](https://alchemy.com/?a=85658530c4) 上创建一个免费账户**，将其添加为 Metamask 的节点提供者，并[获得一些免费的 Goerli ETH](https://goerlifaucet.com/)。
...
首先，让我们到 [alchemy.com](https://alchemy.com/?a=85658530c4) 点击 “登录“ 并创建一个新账户：

![2494](/images/56d3600-web3_eco.png)

选择 Ethereum：

![2660](/images/7719099-ether_eco.png)

给你的应用程序和团队起个名字，选择 Goerli 测试网并点击创建应用程序：

![2520](/images/45f0d4b-Screen_Shot_2022-09-22_at_10.00.53_AM.png)

一旦完成这些步骤，就会跳转到仪表板。点击刚才建立的应用程序，**点击右上角的 “VIEW KEY” 按钮**，并复制 HTTP URL（后面会用到）。

![2491](/images/d2c8933-Screen_Shot_2022-09-22_at_10.13.54_AM.png)
...
![796](/images/af70d3f-Screen_Shot_2022-09-22_at_1.28.09_PM.png)

跳转到以下页面，填写 Goerli 网络和 RPC URL 信息：

![2518](/images/6ca3599-Screen_Shot_2022-09-22_at_1.39.28_PM.png)
...
![357](/images/c0c058f-solid_compiler.png)
...
![3388](/images/73f3bad-filebase.png)
...
点击 transact 将会弹出一个 Metamask 窗口，提示你支付 Gas 费用。 点击确定继续，铸造你的第一个 NFT！
...
![2610](/images/3256828-testnet.png)

有时 OpenSea 很难识别测试网的元数据 — 可能需要 6 个小时才能看到。经过一些时间之后，你的 NFT 应该是可见的，如下所示：

![2840](/images/b36cf81-erc_testnet.png)
