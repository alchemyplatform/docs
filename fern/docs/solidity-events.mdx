...
subtitle: >-
  Solidity events log information to the blockchain outside of smart contracts'
  storage variables using the  keyword. They're emitted by smart contracts and
  read by connected code.
...
![eth\_getLogs](/images/divzjiip8/image/upload/v1671696400/Screen_Shot_2022-12-22_at_3.05.20_PM_tubpq2.png)
