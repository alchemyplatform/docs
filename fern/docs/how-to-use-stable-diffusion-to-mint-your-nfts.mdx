...
subtitle: >-
  Learn how to use Gelato's Web3 functions and Alchemy's top-notch
  infrastructure to use Stable Diffusion to generate images for your NFTs!
slug: docs/how-to-use-stable-diffusion-to-mint-your-nfts
---


![](/images/9618779-Gelato_AI-TUTORIAL_BLOG_1600x900_02_v4.jpg)
...
![Image generated by Stable Diffusion through the given prompt](/images/c1203ea-image.png)
<div align="center" style="color: gray; font-style: italic;">Image generated by Stable Diffusion through the given prompt</div>
...
2. **Enter user arguments:** Type in the arguments you entered in userArgs.Json file: **nftAddress.** ![](/images/f09410f-image.png)

3. **Choose Your Network:** Pick the network for your task to work on. ![](/images/0c16c62-image.png)

4. **Add Your Keys:** Put in your NFT storage and Stable Diffusion API keys. ![](/images/4e84f52-image.png)

5. **Give Life to Your Task:** Last but not least, you'll be asked to name your task. Hit the "Create Task" button, confirm the name and task creation with your wallet, et voila! ![](/images/b800a22-image.png)
