    ...
    <div className="search">
      ...
      <div className="search-options">
        ...
        <a href="/reference/transfers-api-quickstart">
          <button className="fern-button minimal">Transfers API</button>
        </a>
        <a href="/docs/sending-transactions">
          <button className="fern-button minimal">How to send transactions</button>
        </a>
        <a href="/docs/how-to-create-an-nft">
          <button className="fern-button minimal">NFT smart contract</button>
        </a>
      </div>
    </div>
  </div>
