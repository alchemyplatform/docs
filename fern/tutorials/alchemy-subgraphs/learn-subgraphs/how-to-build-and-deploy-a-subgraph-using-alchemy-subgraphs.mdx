...
This step is the easiest. 🥞 You'll now deploy the subgraph you built and compiled locally to be hosted on the [Alchemy Subgraphs](https://dashboard.alchemy.com/signup) platform:
