...
subtitle: A quick guide to setting up your Eth2 node or validator on Prysm with Alchemy as your web3 provider.
...
* **For Prymont testnet**: pyrmont.launchpad.ethereum.org/overview
