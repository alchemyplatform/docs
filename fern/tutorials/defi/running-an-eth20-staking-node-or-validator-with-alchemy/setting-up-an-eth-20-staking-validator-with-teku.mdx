...
subtitle: "A quick guide to setting up your Eth2 node or validator on Teku with Alchemy as your web3 provider."
...
Copy the full path of your keys from when you set up [your initial deposit](/docs). In the previous guide, the example path for the keys were saved in:
