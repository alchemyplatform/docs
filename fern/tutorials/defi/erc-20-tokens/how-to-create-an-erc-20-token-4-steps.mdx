...
subtitle: Tutorial for deploying your own ERC-20 token on Ethereum (testnet) in 4 steps.
...
**The [ERC-20 token standard](https://ethereum.org/en/developers/docs/standards/tokens/erc-20/) is the most popular way to create fungible cryptocurrencies on Ethereum and EVM-compatible blockchains, and therefore allows builders and creators to develop digital assets for their protocol, marketplace, metaverse, or community.** This tutorial will teach you how to create your own ERC-20 token on Ethereum's Goerli testnet using [Alchemy](https://dashboard.alchemy.com/signup), MetaMask, HardHat, and Solidity code snippets. At the end of this tutorial, you will be able to deploy your own ERC-20 token smart contract. The estimated time to complete this guide is 15 minutes.
...
In four steps you'll create and deploy an ERC-20 token on the Goerli test network, using Metamask, Solidity, Hardhat, and [Alchemy](https://dashboard.alchemy.com/signup). This Goerli ERC-20 token will have all the characteristics required above, making it a valid ERC-20 token.
