...
subtitle: Learn how to build a TipJar app that creators can use to receive tips from their supporters.
...
1. Create an Alchemy account: [Sign up here](https://dashboard.alchemy.com/signup)
