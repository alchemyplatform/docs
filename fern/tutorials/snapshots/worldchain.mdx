...
The snapshot service for Worldchain Mainnet is available [here](https://alchemy.com/snapshots/worldchain).
...
You simply go to our [worldchain snapshot service](https://alchemy.com/snapshots/worldchain-mainnet) and you can download the latest available snapshot! In order to use it, simply decompress the archive as per the following instructions and start your node.

**1. Download the snapshot**

```bash
wget <worldchain-snapshot-url>
```
...
```bash
lz4 -c -d <worldchain-snapshot-name>.tar.lz4  | tar -x -C <WORLDCHAIN_HOME>/geth/
```
