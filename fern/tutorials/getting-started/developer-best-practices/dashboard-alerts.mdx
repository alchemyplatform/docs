...
1. Visit the [configure alerts page](https://dashboard.alchemy.com/signup) in the dashboard
...
6. When your alert gets triggered, you’ll get an email about it and will also be able to see it in the notification panel and the [Alerts Hub](https://dashboard.alchemy.com/signup)! **Alerts Email:**
...
9. Edit, deactivate, and delete alerts at any time by visiting your [Alert configuration page](https://dashboard.alchemy.com/signup).
...
You can edit any alert by visiting the [Alerts Configuration page](https://dashboard.alchemy.com/signup). Alert edits will apply to the entire team so make sure to communicate with the alert subscribers or create a new alert if you want to keep multiple versions.
