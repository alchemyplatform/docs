...
Restricting access to your apps means setting up rules that limit which addresses, domains, or IPs can interact with your app or API key. You can set these rules for any app by navigating to the ["Apps" section](https://dashboard.alchemy.com/signup) in your [Alchemy dashboard](https://dashboard.alchemy.com/signup) and selecting the "Edit App" option for the app you want to set the rules for.
