...
### Why It Matters
The Request Logs feature in the Alchemy Dashboard is a powerful tool on many supported blockchains. It solves several critical problems:
...
![](../../assets/request-logs/tools-menu.png)
...
![](../../assets/request-logs/filters.png)
...
![](../../assets/request-logs/request-logs-dashboard.png)
