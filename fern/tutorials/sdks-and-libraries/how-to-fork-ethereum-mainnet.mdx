...
1. [A free Alchemy Account](https://dashboard.alchemy.com/signup)
...
In order to fork Mainnet, we will need to connect to the Ethereum network. The simplest way to do this is by creating [a free Alchemy account here](https://dashboard.alchemy.com/signup). An Alchemy account includes access to a full Ethereum archive node.
...
Now that we have our [Alchemy account](https://dashboard.alchemy.com/signup) setup and an app created, you need to connect your configuration with Hardhat. Hardhat will allow you to fork Mainnet to a local blockchain so that we can test and deploy our smart contracts.
