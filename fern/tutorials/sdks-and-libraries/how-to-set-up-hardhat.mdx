...
* Go to [https://www.alchemy.com/](https://dashboard.alchemy.com/signup) and create an account.
* In the [Dashboard](https://dashboard.alchemy.com/signup), select the 'Create App' button.
