...
Separating the wallet and the provider allows developers to handle them separately. For instance, you can use [Alchemy](https://dashboard.alchemy.com/signup) as a provider and Metamask as a wallet if you're leveraging ethers on your dapp.
