...
subtitle: Learn how to send an EIP-1559 transaction that transfers ERC20 tokens.
...
Next, navigate to the [Alchemy Dashboard](https://dashboard.alchemy.com/signup) and [create a new app](/reference/alchemy-quickstart-guide). Make sure you set the chain to Ethereum and the network to Sepolia. Once the app is created, click on your app's *View Key* button on the dashboard. Take note of the **API KEY**.
