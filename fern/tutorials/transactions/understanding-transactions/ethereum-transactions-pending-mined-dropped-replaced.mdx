...
* [Create notifications for dropped and mined transactions](/docs/alchemy/tutorials/streaming-data/transaction-notifications/how-to-track-mined-and-pending-ethereum-transactions)
