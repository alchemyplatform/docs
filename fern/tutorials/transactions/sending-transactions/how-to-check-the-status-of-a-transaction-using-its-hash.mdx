...
url: https://docs.alchemy.com/docs/how-to-check-the-status-of-a-transaction-using-its-hash
slug: docs/how-to-check-the-status-of-a-transaction-using-its-hash
---

<Tip title="Don’t have an API key?" icon="star">
  Start using this API in your app today. [Get started for free](https://dashboard.alchemy.com/signup/?a=tx-status)
</Tip>
