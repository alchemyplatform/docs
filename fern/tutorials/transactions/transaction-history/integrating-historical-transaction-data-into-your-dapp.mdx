...
While building historical queries into dApps has traditionally been complicated, time-consuming, and error-prone, the [Alchemy Transfers API](/docs/alchemy/enhanced-apis/transfers-api) allows for developers to query historical wallet activity, token transfers, and other account-driven transactions in a simple transaction.
...
![1136](5d8eadf-image_7.png "image (7).png")
...
![640](a036824-image_8.png "image (8).png")
...
![408](7c67380-image_9.png "image (9).png")
...
![1173](7613b3f-image_10.png "image (10).png")
...
![580](9a06adb-img_1.PNG "img (1).PNG")
...
![1881](b6c4aaf-image_11.png "image (11).png")
...
### 1-2. Complete [Steps 2 & 3](/docs/alchemy/tutorials/transfers-tutorial#2-create-a-free-alchemy-account) from the Heroku Project.
...
![1881](12f0f77-image_12.png "image (12).png")
