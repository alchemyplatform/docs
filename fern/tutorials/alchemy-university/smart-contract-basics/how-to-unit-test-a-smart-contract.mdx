...
![UI](Screen_Shot_2022-12-14_at_9.29.17_PM.png)
...
![hardhat2](Screen_Shot_2022-12-21_at_11.57.35_AM.png)
...
![test-passes](Screen_Shot_2022-12-21_at_12.36.48_PM.png)
...
> Pro-tip: just copy-paste the entire previous `it` function and replace the contents for the new test! No need to write out the whole syntax again.
