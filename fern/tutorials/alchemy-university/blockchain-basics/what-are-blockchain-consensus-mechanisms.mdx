...
url: "https://docs.alchemy.com/docs/what-are-blockchain-consensus-mechanisms"
...
![blockchain-nodes](O7jloYu.jpg)

Access [the slides here](https://docs.google.com/presentation/d/1HKZ1l_8XAuj4N_6MRFVn155tnigFKNkiZNWw9GujP_4/edit?usp=sharing).
...
6. Else, restart process from step #2, but increment nonce ![](cryptocurrency_mining_mov.gif)
