...
description: Follow this tutorial to learn the fastest way to mint a collection of Solana NFTs using Alchemy, Metaplex, Bundlr, Arweave, and Hashlips.
subtitle: Follow this tutorial to learn the fastest way to mint a collection of Solana NFTs using Alchemy, Metaplex, Bundlr, Arweave, and Hashlips.
url: https://docs.alchemy.com/docs/how-to-build-a-solana-nft-collection
...
3. [Alchemy API Key](https://dashboard.alchemy.com/signup)
...
Here's what your frontend DApp will look like: ![Your DApp Website](dapp-website.png)

When you're done, you'll be able to mint your NFTs using any Solana wallet (i.e. Phantom) on the devnet via Alchemy's Solana RPC. ![Example Minted NFT](example-minted-nft-in-wallet.png)
...
Notice that the configuration above is in `mainnet-beta`. In order for us to do some testing, we must change this to a devnet URL. We'll be using a dedicated devnet RPC from Alchemy. If you don't already have an account, click on [this link](https://dashboard.alchemy.com/signup) and sign up to create an API key.
...
![Build Folder Contents](build-result.png)
...
![Assets Folder Overview](assets-collection.png)
...
![create-config Sample Configuration](create-config.png)
...
![Candy Machine UI Repo](candy-machine-ui.png)
...
![Your DApp Website](dapp-website.png)
