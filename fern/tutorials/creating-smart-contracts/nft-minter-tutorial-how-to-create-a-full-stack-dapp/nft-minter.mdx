...
description: "Learn how to build an NFT minter by connecting a smart contract to a React frontend using Metamask and popular web3 tools."
url: "https://docs.alchemy.com/docs/nft-minter"
...
<Info>
  ...
  React—know how components, props, hooks (useState/useEffect), and basic
  function calling works. If you've never heard of those terms before, you may
  want to check out this [**Intro to React
  tutorial**](https://reactjs.org/tutorial/tutorial.html). For the more visual
  learners, we highly recommend this excellent [**Full Modern React
  Tutorial**](https://www.youtube.com/playlist?list=PL4cUxeGkcC9gZD-Tvwfod2gaISzfRiP9d)
  video series by Net Ninja.
</Info>
...
<Info>
  The biggest difference between the two NFT smart contact standards is that
  ERC-1155 is a multi-token standard and includes batch functionality, whereas
  the ERC-721 is a single-token standard and therefore only supports
...
<Info>
  ...
  and other attributes. Here's [**an example of a
...
{/* [![How to Create an NFT Tutorial](https%3A%2F%2F3169887760-files.gitbook.io%2F~%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MB17w56kk7ZnRMWdqOL%252Fsocialpreview%252FAMk78lrzTEIIHSKefoey%252Falchemy-logo-blue-gradient.png%3Falt%3Dmedia%26token%3Dae77654d-ac15-44b9-8952-20e6769be385)](https://docs.alchemy.com/alchemy/tutorials/how-to-create-an-nft) */}

[![docs.alchemy.com](spaces%2F-MB17w56kk7ZnRMWdqOL%2Favatar-1631043648701.png)docs.alchemy.com](https://docs.alchemy.com/alchemy/tutorials/how-to-create-an-nft)
...
![2880](3b2bc2f-RQXRr70mP174PjsKQI_jMKuq.png "RQXRr70mP174PjsKQI_jMKuq.png")
...
<CodeGroup>```shell shell cd minter-starter-files npm install ```</CodeGroup>
...
<CodeGroup>
  ```javascript Minter.js //State variables const [walletAddress, setWallet] =
  useState(""); const [status, setStatus] = useState(""); const [name, setName]
  = useState(""); const [description, setDescription] = useState(""); const
  [url, setURL] = useState(""); ```
</CodeGroup>
...
![796](b1bf3a8-Screen_Shot_2022-09-22_at_1.28.09_PM.png "Screen Shot 2022-09-22 at 1.28.09 PM.png")
...
To double check our balance is there, let’s make an [eth_getBalance](/reference/eth-getbalance) request using [Alchemy’s composer tool](https://composer.alchemyapi.io/?composer_state=%7B%22network%22%3A0%2C%22methodName%22%3A%22eth_getBalance%22%2C%22paramValues%22%3A%5B%22%22%2C%22latest%22%5D%7D). This will return the amount of Eth in our wallet. After you input your Metamask account address and click “Send Request”, you should see a response like this:
...
<Info>
  ...
  suggest that the user sign messages and transactions. Check out the
  [**Metamask
...
<CodeGroup>
  ```javascript Minter.js import {(useEffect, useState)} from "react"; import{" "}
  {
    (connectWallet, getCurrentWalletConnected) //import here
  }{" "}
...
![2880](e80d734-J__0NjUkj_6BObi1Q4Q3eRe6.png "J__0NjUkj_6BObi1Q4Q3eRe6.png")

Create your Pinata API key

You'll then be shown a popup with your API info. Make sure to put this somewhere safe.

![2880](f1b2bc4-to1HORepBqC2D350oKtfQJlh.png "to1HORepBqC2D350oKtfQJlh.png")
...
<CodeGroup>```javascript .env vim .env ```</CodeGroup>
...
<CodeGroup>
  ```javascript pinata.js require('dotenv').config(); const key =
  process.env.REACT_APP_PINATA_KEY; const secret =
...
![2880](b8ca9d7-avF_wnWdWxL9X9YtBm8FO8bw.png "avF_wnWdWxL9X9YtBm8FO8bw.png")

Create a new app

Name your app (we chose "My First NFT!"), offer a short description, and choose “Goerli” for your network.

![2525](f209c54-Screen_Shot_2022-10-04_at_3.53.24_PM.png "Screen Shot 2022-10-04 at 3.53.24 PM.png")
...
![843](1a7af71-mvmYwXa2U7TlurPx9Bqh2brD.gif "mvmYwXa2U7TlurPx9Bqh2brD.gif")
...
<CodeGroup>```shell shell npm install @alch/alchemy-web3 ```</CodeGroup>
...
<CodeGroup>
  ```javascript javascript require('dotenv').config(); const alchemyKey =
  process.env.REACT_APP_ALCHEMY_KEY; const {createAlchemyWeb3} =
  require("@alch/alchemy-web3"); const web3 = createAlchemyWeb3(alchemyKey); ```
</CodeGroup>

<Info>
  [Alchemy Web3](https://github.com/alchemyplatform/alchemy-web3) is a wrapper
  around [Web3.js](https://web3js.readthedocs.io/en/v1.2.9/), providing enhanced
  API methods and other crucial benefits to make your life as a web3 developer
  easier. It is designed to require minimal configuration so you can start using
...
<CodeGroup>
  ```javascript javascript import {pinJSONToIPFS} from './pinata.js' ```
</CodeGroup>
...
<CodeGroup>
  ...
  {(connectWallet, getCurrentWalletConnected, mintNFT)} from
  "./utils/interact.js"; ```
</CodeGroup>
...
{/* [![How to Build an NFT Website](https%3A%2F%2F3169887760-files.gitbook.io%2F~%2Ffiles%2Fv0%2Fb%2Fgitbook-x-prod.appspot.com%2Fo%2Fspaces%252F-MB17w56kk7ZnRMWdqOL%252Fsocialpreview%252FAMk78lrzTEIIHSKefoey%252Falchemy-logo-blue-gradient.png%3Falt%3Dmedia%26token%3Dae77654d-ac15-44b9-8952-20e6769be385)](https://docs.alchemy.com/alchemy/tutorials/nft-minter/how-do-i-deploy-nfts-online) */}

[![docs.alchemy.com](spaces%2F-MB17w56kk7ZnRMWdqOL%2Favatar-1631043648701.png)docs.alchemy.com](https://docs.alchemy.com/alchemy/tutorials/nft-minter/how-do-i-deploy-nfts-online)

[How to Build an NFT Website](https://docs.alchemy.com/alchemy/tutorials/nft-minter/how-do-i-deploy-nfts-online)
...
<Info>
  The transactions sent through Metamask will use Metamask's default provider
  (not necessarily your Alchemy endpoint). If you'd like to send those
  transactions through Alchemy to unlock debugging tools and the [**Alchemy
  Notify** ](/docs/alchemy-notify)suite, check out [**this
  guide**](/docs/how-to-add-alchemy-rpc-endpoints-to-metamask) for connecting
  Metamask to Alchemy.
</Info>
