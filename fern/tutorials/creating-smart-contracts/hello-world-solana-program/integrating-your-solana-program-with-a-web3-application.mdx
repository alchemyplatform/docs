...
<Info>
  You should have an Alchemy account and Phantom wallet from the previous tutorials! If you didn’t make them, you can go [here](https://dashboard.alchemy.com/signup) to create an Alchemy Account, and follow this [setup](/docs/how-to-setup-your-solana-development-environment#3-install-your-phantom-wallet) tutorial to download Phantom.
</Info>
