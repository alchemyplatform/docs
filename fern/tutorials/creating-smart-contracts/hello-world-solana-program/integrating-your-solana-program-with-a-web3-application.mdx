...
We’ll use our Alchemy RPC URL as an environment variable in our Next.js application, so we’ll need to create an `.env.local` file at the top-level `app` folder. Add this line and you’re golden:
