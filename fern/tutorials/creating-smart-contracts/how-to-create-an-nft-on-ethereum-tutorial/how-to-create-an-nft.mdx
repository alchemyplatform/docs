...
To understand what’s going on under the hood, let’s navigate to the Logs tab in our [Alchemy dashboard](https://dashboard.alchemy.com/signup). If you have multiple Alchemy apps make sure to filter by app and select “MyNFT”.
