---
title: How do I set a price on an NFT?
description: Guide on how to set a price on your NFT
subtitle: Guide on how to set a price on your NFT
slug: docs/how-do-i-set-a-price-on-an-nft
---
...
<Warning>
  The following section is not a turnkey solution. In [Step 6 ](/docs/alchemy/tutorials/how-to-create-an-nft#step-10-write-our-contract)of the [NFT Creation Tutorial](/docs/alchemy/tutorials/how-to-create-an-nft), we would need to alter the Solidity to accept payments for minting which means that any frontend`ethers.js`logic dictating minting would need to include the`msg.value`parameter to allow for the transfer of ETH.
</Warning>
...
<Warning>
  NFT auction platforms typically charge for listing and handling the auction process. Keep to date with different platforms to find competitive rates and maximize your NFT sales. [Zora](https://zora.co) and [SuperRare](https://superrare.com) are two alternative platforms that also offer similar services to OpenSea.
</Warning>
