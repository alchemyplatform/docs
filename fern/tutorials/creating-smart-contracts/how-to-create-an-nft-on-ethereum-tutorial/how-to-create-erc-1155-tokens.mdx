...
subtitle: Learn how to create and deploy an ERC-1155 smart contract that is fungibility-agnostic and gas efficient.
...
You will need an [Alchemy app](https://dashboard.alchemy.com/signup) and your app’s API key in this tutorial. To create one, check out [this video](https://www.youtube.com/watch?v=tfggWxfG9o0) or follow the instructions below:
