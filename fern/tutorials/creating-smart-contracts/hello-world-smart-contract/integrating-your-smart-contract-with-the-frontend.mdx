...
* Read data from your smart contract using the [Alchemy Web3](/docs/alchemy/documentation/alchemy-web3) API
...
The next step is to include some of the newly installed dependencies in your `webpack.config.js` file. Locate the file in your *node\_modules* `react-scripts` directory, i.e., `/Users/...../hello-world-part-four-tutorial/starter-files/node_modules/react-scripts/config/webpack.config.js`.
...
So remember how in Part 2 of this tutorial, we used our [Alchemy Web3 key to reading from our smart contract](/docs/alchemy/tutorials/hello-world-smart-contract/interacting-with-a-smart-contract#step-1-install-web3-library)? You'll also need an Alchemy Web3 key in your dApp to read from the chain.
...
To load your Hello World smart contract, you'll need its contract address and ABI, both of which can be found on Etherscan if you [completed Part 3 of this tutorial](/docs/alchemy/tutorials/hello-world-smart-contract/submitting-your-smart-contract-to-etherscan).
...
The main difference is that instead of calling the method *eth\_requestAccounts*, which opens Metamask for the user to connect their wallet, here we call the method *eth\_accounts*, which returns an array containing the Metamask addresses currently connected to our dApp.
