...
Check out [these instructions](/docs/alchemy/introduction/getting-started#1.create-an-alchemy-key) for creating a new app. Make sure to specify **Arbitrum** as the chain and choose Mainnet or Goerli.
