...
subtitle: Optimism makes Ethereum transactions cheaper and faster. This section will include ways to add Optimism Mainnet and Kovan Testnet as your custom MetaMask RPC node provider.
...
2. [Mainnet vs. Testnet (Kovan)](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-optimism-to-metamask#mainnet-vs.-mumbai-testnet)
...
3. [Update Optimism Testnet Kovan](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-optimism-to-metamask#update-polygon-testnet-mumbai)
...
Check out [these instructions](/docs/alchemy/introduction/getting-started#1.create-an-alchemy-key) for creating a new app. Make sure to specify **Optimism** as the chain and choose Mainnet or Kovan as the network.
...
* **Chain ID**: 69
* **Currency Symbol**: ETH
* **Block Explorer URL**: kovan-optimistic.etherscan.io
