...
subtitle: This article explains how Solana developers can update their Phantom wallet settings to add a custom Solana endpoint.
...
2. [Create a free account](https://dashboard.alchemy.com/signup)\*
