...
subtitle: Learn how to add Polygon zkEVM Mainnet and Testnet to Metamask with your custom RPC endpoint.
...
Check out [these instructions](/docs/alchemy/introduction/getting-started#1.create-an-alchemy-key) for creating a new app. Make sure to specify **Polygon zkEVM** as the chain and choose Mainnet or Testnet as the network.
...
* **Chain ID**: 1442
* **Currency Symbol**: ETH
* **Block Explorer URL**: testnet-zkevm.polygonscan.com
