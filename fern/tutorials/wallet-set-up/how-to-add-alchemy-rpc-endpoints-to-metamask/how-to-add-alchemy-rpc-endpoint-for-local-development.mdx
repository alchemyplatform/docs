...
subtitle: Use dotenv to set an environment-wide variable containing your Alchemy RPC HTTP endpoint.
...
1. Go to [Alchemy](https://dashboard.alchemy.com/signup) and create an account
