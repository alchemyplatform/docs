...
subtitle: Polygon is an Ethereum scaling platform that is decentralized and enables developers to build scalable dApps. This guide will teach you how to add a custom Polygon RPC endpoint to your Metamask.
slug: docs/how-to-add-polygon-to-metamask
---

## Overview

1. [What is Polygon?](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#undefined)
2. [Mainnet vs. Testnet (Mumbai)](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#mainnet-vs.-mumbai-testnet)
3. [Create a free Alchemy account](https://dashboard.alchemy.com/signup)
4. [Create a Polygon App](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#create-an-arbitrum-app)
5. [Add to Wallet](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#add-to-wallet)

**[Updating your Metamask RPC manually](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#updating-your-metamask-rpc-manually)**

1. [Copy your HTTP API Key](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#copy-your-http-api-key)
2. [Update Polygon Mainnet](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#updating-arbitrum-mainnet)
3. [Update Polygon Testnet Mumbai](/docs/alchemy/guides/connecting-metamask-to-alchemy/how-to-add-polygon-to-metamask#update-arbitrum-testnet-rinkeby)
...
Check out [these instructions](/docs/alchemy/introduction/getting-started#1.create-an-alchemy-key) for creating a new app. Make sure to specify **Polygon** as the chain and choose Mainnet or Mumbai.
