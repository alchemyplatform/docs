...
subtitle: The document describes the EtherInput component, which allows users to input and convert amounts between ETH and USD, detailing its import, usage, and available props.
