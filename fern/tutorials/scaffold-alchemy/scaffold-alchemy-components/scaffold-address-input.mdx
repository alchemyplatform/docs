---
title: AddressInput
description: The document describes an Ethereum address input component that validates address formats, resolves ENS domains, displays avatars, and shows blockie images, along with its import, usage, and available props.
subtitle: The document describes an Ethereum address input component that validates address formats, resolves ENS domains, displays avatars, and shows blockie images, along with its import, usage, and available props.
url: https://docs.alchemy.com/docs/scaffold-address-input
