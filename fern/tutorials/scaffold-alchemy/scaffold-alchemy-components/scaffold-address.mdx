---
title: "Address"
description: "The document describes a component that displays an Ethereum address or ENS name with an optional avatar, allows copying the address, and can link to a block explorer. It includes customization options for display format, size, and link behavior."
subtitle: "The document describes a component that displays an Ethereum address or ENS name with an optional avatar, allows copying the address, and can link to a block explorer. It includes customization options for display format, size, and link behavior."
url: "https://docs.alchemy.com/docs/scaffold-address"
