...
description: "Use this hook to read public variables and get data from read-only functions of your smart contract. const { data: totalCounter } = useScaffoldReadContract({ contractName: \"YourContract\", functionName: \"userGreetingCounter\", args: [\"0xd8da6bf26964af9d7eed9e03e53415d37aa96045\"], }); This example retr..."
url: "https://docs.alchemy.com/docs/usescaffoldreadcontract"
slug: "docs/usescaffoldreadcontract"
---
