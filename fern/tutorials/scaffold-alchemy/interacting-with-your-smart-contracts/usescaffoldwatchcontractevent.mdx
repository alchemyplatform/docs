...
description: "Use this hook to subscribe to events emitted by your smart contract, and receive real-time updates when these events are emitted. useScaffoldWatchContractEvent({ contractName: \"YourContract\", eventName: \"GreetingChange\", // The onLogs function is called whenever a GreetingChange event is emitted by ..."
