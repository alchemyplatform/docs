...
description: "Use this hook to retrieve historical event logs for your smart contract, providing past activity data, with the option to watch for new events."
subtitle: "Use this hook to retrieve historical event logs for your smart contract, providing past activity data, with the option to watch for new events."
url: "https://docs.alchemy.com/docs/usescaffoldeventhistory"
slug: "docs/usescaffoldeventhistory"
---
