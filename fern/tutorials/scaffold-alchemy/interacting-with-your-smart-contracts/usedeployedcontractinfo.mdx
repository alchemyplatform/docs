...
description: "Use this hook to fetch details about a deployed smart contract, including the ABI and address. const { data: deployedContractData } = useDeployedContractInfo({ contractName: \"YourContract\" }); This example retrieves the details of the deployed contract with the specified name and stores the details ..."
