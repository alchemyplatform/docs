...
description: "Use this hook to send a transaction to your smart contract to write data or perform an action. const { writeContractAsync: writeYourContractAsync } = useScaffoldWriteContract({ contractName: \"YourContract\" }); The following configuration options can be passed to the hook: Configuration Parameter Typ..."
url: "https://docs.alchemy.com/docs/usescaffoldwritecontract"
slug: "docs/usescaffoldwritecontract"
---
