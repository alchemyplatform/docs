---
title: "useTransactor"
description: "Use this hook to interact with the chain and give UI feedback on the transaction status. Any error will instead show a popup with nice error message. const transactor = useTransactor(); const writeTx = transactor({ to: \"0x97843608a00e2bbc75ab0C1911387E002565DEDE\", // address of buidlguidl.eth value:..."
url: "https://docs.alchemy.com/docs/usetransactor"
slug: "docs/usetransactor"
---
