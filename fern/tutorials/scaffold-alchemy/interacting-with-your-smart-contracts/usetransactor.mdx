---
title: useTransactor
description: Use this hook to interact with the chain and give UI feedback on the transaction status.
subtitle: Use this hook to interact with the chain and give UI feedback on the transaction status.
