...
### **2. [How to create a Modular Smart Contract Account and send UserOps with Account Kit](/docs/how-to-create-a-modular-smart-contract-account-and-send-userops-with-account-kit)**
