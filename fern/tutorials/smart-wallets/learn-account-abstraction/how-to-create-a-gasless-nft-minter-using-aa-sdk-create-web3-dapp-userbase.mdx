...
subtitle: Learn how to set up a full-stack end-to-end solution that implements account abstraction in order to enable gasless NFT minting.
...
3. Copy-paste the following into your app's newly-created `tailwind.config.js` file:
...
2. Get a smart contract wallet's owned NFTs (uses the [Alchemy SDK](https://github.com/alchemyplatform/alchemy-sdk))
...
1. In your terminal, run `npm i @alchemy/aa-alchemy @alchemy/aa-core alchemy-sdk`
...
<CodeGroup>
  ```env env SEPOLIA_ENTRYPOINT_ADDRESS=
