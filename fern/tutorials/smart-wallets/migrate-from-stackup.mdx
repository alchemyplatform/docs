...
description: "We’re thrilled to support your migration to Alchemy! This guide will walk you through the process and any necessary changes to your setup, and highlight the benefits of using our stack. Why Alchemy? There are many unique benefits of using Alchemy, but here are the three biggest ones: 1. We’re here f..."
subtitle: "We’re thrilled to support your migration to Alchemy! This guide will walk you through the process and any necessary changes to your setup, and highlight the benefits of using our stack. Why Alchemy? There are many unique benefits of using Alchemy, but here are the three biggest ones: 1. We’re here f..."
...
![🙀 UI components COMING SOON!! It’s the last piece 🧩](4680e632d4806238d8f56868a69f1b3e039a52141359b82660581e565f768b17-Account_kit.png)
...
Go to the [Alchemy Dashboard](https://dashboard.alchemy.com/signup) and create an account if you haven’t already.

![Create an Alchemy Account](62f0803c246ed2a12df8b873ed2157becbdebf030287a997806dcaec624067b0-Alchemy_account.png)

## 2. Create an App

1. Go to the [Apps dashboard](https://dashboard.alchemy.com/signup)
...
<Info>
  For additional chain support, please contact us at <Markdown src="../../../snippets/support-email.mdx" /> or open a ticket in the dashboard.
</Info>
...
Create a policy in the [Gas Manager dashboard](https://dashboard.alchemy.com/gas-manager/policy/create) to sponsor gas for your users.
...
1. Replace RPC URL: `https://api.stackup.sh/v1/node/api_key` → `https://eth-mainnet.g.alchemy.com/v2/alchemy_api_key`
   ...
   * Replace alchemy\_api\_key with the key from step 2 (from [app dashboard](https://dashboard.alchemy.com/signup))
...
2. Update RPC methods
   ...
   1. [`pm_sponsorUserOperation`](https://docs.stackup.sh/reference/pm-sponsoruseroperation) → [`alchemy_requestGasAndPaymasterAndData`](/reference/alchemy-requestgasandpaymasteranddata)
      ...
      * Add the policyId from step 3 ([gas manager dashboard](https://dashboard.alchemy.com/gas-manager/policy/create))
...
<Info>
  If you need additional SDK migration support, please contact us at <Markdown src="../../../snippets/support-email.mdx" /> or open a ticket in the dashboard. See [Account
  Kit](https://accountkit.alchemy.com/) to use our SDK.
</Info>

<Info>
  For additional support, please contact us at <Markdown src="../../../snippets/support-email.mdx" /> or open a ticket in the dashboard.
</Info>
