...
Create a policy in the [Gas Manager dashboard](https://dashboard.alchemy.com/signup) to sponsor gas for your users.
...
2. Update RPC methods
   ...
   1. [`pm_sponsorUserOperation`](https://docs.stackup.sh/reference/pm-sponsoruseroperation) → [`alchemy_requestGasAndPaymasterAndData`](/reference/alchemy-requestgasandpaymasteranddata)
      ...
      * Add the policyId from step 3 ([gas manager dashboard](https://dashboard.alchemy.com/signup))
