...
description: "Step 3 in the 'Smart Accounts From Scratch' Series: Let's validate the user operation signature!"
subtitle: "Step 3 in the 'Smart Accounts From Scratch' Series: Let's validate the user operation signature!"
url: https://docs.alchemy.com/docs/3-account-validation
...
For this step, we'll need to install OpenZeppelin's contract library (if you're using npm you can do `npm i @openzeppelin/contracts@4.9.5`). Then, in your smart account, you can import the ECDSA utility from `/contracts/utils/cryptography/ECDSA.sol`.
