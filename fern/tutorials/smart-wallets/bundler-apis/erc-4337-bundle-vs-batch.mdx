...
description: "A batch refers to a group of calls inside a single user operation, whereas a bundle is a group of user ops from different users."
subtitle: "A batch refers to a group of calls inside a single user operation, whereas a bundle is a group of user ops from different users."
url: "https://docs.alchemy.com/docs/erc-4337-bundle-vs-batch"
...
![Diagram of multiple user ops in a single bundle.](8e91713-image.png)
...
![Diagram of a multiple calls in a single user operation.](c2ebc6a-image.png)
