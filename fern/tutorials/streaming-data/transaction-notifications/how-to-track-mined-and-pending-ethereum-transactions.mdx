...
* a script that uses [Alchemy Notify API](/docs/alchemy/enhanced-apis/notify-api) to detect mined transactions
...
For our example, we’ll use the [Address Activity](/docs/alchemy/guides/using-notify#address-activity) notification, but you should be able to easily swap out any of the others for your own use case.
...
With our WebSocket script above, we are able to receive information about pending transactions. Now, we want to receive information on mined transactions! For this, we use[ Alchemy Notify](/docs/alchemy/documentation/apis/enhanced-apis/notify-api).
