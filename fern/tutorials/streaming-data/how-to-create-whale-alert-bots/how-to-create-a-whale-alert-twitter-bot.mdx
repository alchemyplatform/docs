...
subtitle: Learn how to build a Twitter bot that tracks activity on whale wallet addresses on Ethereum. This tutorial also works with Polygon, Arbitrum, and Optimism.
...
Create the address activity webhook to track the event data sent to Zapier. If you don't have one, [create a free Alchemy account](https://dashboard.alchemy.com/signup).
