...
description: Track the activity of whales on Ethereum, Polygon, Arbitrum, and Optimism in Discord using Alchemy webhooks.
subtitle: Track the activity of whales on Ethereum, Polygon, Arbitrum, and Optimism in Discord using Alchemy webhooks.
url: https://docs.alchemy.com/docs/how-to-create-a-whale-alert-discord-bot
...
![1600](8a9de4f-Untitled_17.png "Untitled (17).png")

How to create a new automation in Zapier with the "Catch Hook" event trigger.
...
![1600](851facb-Untitled_18.png "Untitled (18).png")
...
![1600](6e5467e-Untitled_19.png "Untitled (19).png")
...
![1600](881ad4b-Untitled_20.png "Untitled (20).png")

Message text for the Discord whale alert bot that pulls parsed information from Alchemy's Ethereum webhook.
...
![1600](87bfac0-Untitled_21.png "Untitled (21).png")
...
![1600](4b4b3ed-Untitled_22.png "Untitled (22).png")

An example Discord message that uses the webhook response to customize the text of a whale wallet receiving tokens.
