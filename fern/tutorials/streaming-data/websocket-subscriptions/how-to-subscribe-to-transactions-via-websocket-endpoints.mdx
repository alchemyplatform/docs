...
[![docs.alchemy.com](https://alchemyapi-res.cloudinary.com/image/upload/v1764180091/docs/api-reference/websockets/0c06bc6-small-alchemy-circle-logo.png)docs.alchemy.com](/docs/reference/alchemy-pendingtransactions)
...
You now know how to use WebSocket connections with Viem and Ethers.js to [subscribe to pending transactions](/reference/alchemy-pendingtransactions) and filter them based on addresses.
