...
In this tutorial, we will test and create a sample project using the [`alchemy_minedTransactions`](/reference/alchemy-minedtransactions) method with Viem and Ethers.js.
...
You now know how to use WebSocket connections with Viem and Ethers.js to [subscribe to mined transactions](/reference/alchemy-minedtransactions) and filter them based on addresses.
