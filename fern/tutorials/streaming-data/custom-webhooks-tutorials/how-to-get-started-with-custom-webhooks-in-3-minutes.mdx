...
In this tutorial, we will be learning how to set up Alchemy’s **Custom Webhook** (one of the many types of [Alchemy Webhooks](/docs/alchemy/enhanced-apis/notify-api/using-notify)) in the Notify GraphQL playground. This will allow us to be more familiar with how to set-up and build with Custom Webhooks.
