...
To start with Alchemy’s Custom Webhooks, visit the Alchemy website and [create an account](https://dashboard.alchemy.com/signup). This will give you access to the Alchemy Dashboard, which is your starting point.
