...
Once you're fully signed up, head over to the [Alchemy Notify dashboard](https://dashboard.alchemy.com/signup) to grab your Notify Auth Token. This authentication token allows Alchemy's Custom Webhook service to talk with Zapier.
