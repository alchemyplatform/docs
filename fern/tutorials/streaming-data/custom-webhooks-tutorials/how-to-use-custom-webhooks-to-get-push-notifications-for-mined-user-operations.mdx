...
<Info>
  ...
  * Get your auth token from the [webhooks dashboard](https://dashboard.alchemy.com/signup)
</Info>
...
<Info>
  ...
  [these](/reference/notify-api-faq#why-am-i-receiving-so-many-webhook-events)
