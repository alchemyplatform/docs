...
subtitle: This two-part tutorial will explore two ways you can deterministically deploy a contract across multiple networks.
...
* Node.JS (>14) and npm installed ([Install NodeJs and NPM](/docs/alchemy/guides/alchemy-for-macs#1-install-nodejs-and-npm))
...
For each network, we will [create a unique Alchemy API key](https://dashboard.alchemy.com/signup) to connect to the five chains above:
...
* [Alchemy's Web3.js](/docs/alchemy/documentation/alchemy-web3)
