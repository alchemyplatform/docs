...
<Info>
  If you are new to using the NFT API, check out the [NFT API documentation](/reference/nft-api-quickstart) to learn more about how the NFT API works.
</Info>
...
Now, let's retrieve a list of all NFTs owned by a particular wallet (if you're not sure how to do this, check out our [getNFTs API documentation](/reference/getnfts)).
