...
description: Learn how to find the owner of an NFT (ERC-721 or ERC-155) on Ethereum and Polygon in one request using the getOwnersForToken endpoint.
subtitle: Learn how to find the owner of an NFT (ERC-721 or ERC-155) on Ethereum and Polygon in one request using the getOwnersForToken endpoint.
url: https://docs.alchemy.com/docs/how-to-check-the-owner-of-an-nft
...
![1440](1154229-Screenshot_2022-06-18_at_12.02.00_PM.png "Screenshot 2022-06-18 at 12.02.00 PM.png")
...
![1440](98f197d-Screenshot_2022-06-18_at_12.19.18_PM.png "Screenshot 2022-06-18 at 12.19.18 PM.png")
...
To make requests to the NFT API, you can use direct HTTP requests with fetch or axios. We provide code samples for each.

From your terminal, run the following commands:

<CodeGroup>
  ```shell Simple Fetch (Recommended)
  mkdir nft-owner && cd nft-owner
  npm init -y
  // fetch comes preinstalled with node versions 18 and higher
  touch main.js
  ```
