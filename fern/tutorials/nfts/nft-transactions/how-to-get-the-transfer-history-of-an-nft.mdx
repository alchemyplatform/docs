...
In this tutorial, we will write a script in Node that retrieves the transfer history of an NFT in the Bored Ape Yacht Club collection. We will achieve this by using [Alchemy](https://dashboard.alchemy.com/signup) and the [Transfers API](/reference/transfers-api).
...
* [Create a free Alchemy account.](https://dashboard.alchemy.com/signup)

### Step 1: Create an Alchemy app

To create an Alchemy app, [sign up for a free account](https://dashboard.alchemy.com/signup) and:
...
Ready to start using the Alchemy NFT API? [Create a free Alchemy account ](https://dashboard.alchemy.com/signup)and do share your project with us!
