...
subtitle: Learn how to create a Next.js frontend that powers an on-chain game similar to Cryptokitties and Axie Infinity
...
We will need an [Alchemy app](https://dashboard.alchemy.com/signup) to use the NFT API, implement connect wallet functionality, and send transactions to the Goerli blockchain. You can use the same app that you created in Part I. To re-iterate, this is how you go about creating an app:
...
If you enjoyed this tutorial about creating NFT games or happen to build more functionality on top of this, tweet us at [@Alchemy](https://twitter.com/Alchemy)!
