...
We have already created a starter repository for you that implements helpful functionality such as the _connect wallet_ feature.
...
<Info>
  In order to understand what various parts of the code does, do make sure to
  read the comments associated with each section.
</Info>
