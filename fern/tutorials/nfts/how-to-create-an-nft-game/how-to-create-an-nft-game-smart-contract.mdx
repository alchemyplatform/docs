...
subtitle: Learn how to create a contract that powers an on-chain NFT game similar to CryptoKitties and Axie Infinity
...
We're going to deploy and test our contract on the Goerli testnet. In order to do this, we will require a [free Alchemy account](https://dashboard.alchemy.com/signup).
...
If you enjoyed this tutorial about creating NFT games, tweet us at [@Alchemy](https://twitter.com/Alchemy) and give us a shoutout!
