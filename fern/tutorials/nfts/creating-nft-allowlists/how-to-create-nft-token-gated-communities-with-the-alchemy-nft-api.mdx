...
<CodeGroup>
  ...
  const main = async () => {
    try {
      ...
      const url = `${baseURL}/isHolderOfCollection?wallet=vitalik.eth&contractAddress=0xbc4ca0eda7647a8ab7c2061c2e118a18a936f13d`;
      ...
      console.log('Is holder:', data.isHolderOfCollection);
    } catch (error) {
