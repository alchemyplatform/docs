...
**PRECEDENCE**: These rules override the repo-wide style guide in [`STYLE_RULES.md`](https://github.com/alchemyplatform/docs/blob/main/STYLE_RULES.md) for content under `content/wallets/`.
...
**Scope**: These guidelines extend the repo-wide style guide in [`STYLE_RULES.md`](https://github.com/alchemyplatform/docs/blob/main/STYLE_RULES.md). If a Wallets-specific rule conflicts with the repo-wide guide, follow this document for Wallets content.
