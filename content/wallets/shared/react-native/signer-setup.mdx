...
2. Activate **smart wallets** in your [Smart Wallets Dashboard](https://dashboard.alchemy.com/apps/latest/services/smart-wallets/overview)
   ...
   <img src="https://alchemyapi-res.cloudinary.com/image/upload/v1764187298/docs/aa-sdk/images/getting-started/apply-config-to-app.png" alt="apply your the config to the app from the first step" style={{ width: "50%" }} />
   ...
   * For testing, simply setting up a simple
     ...
     way to get started. a sample implementation of this can be found the [`example`](https://github.com/alchemyplatform/aa-sdk/blob/main/account-kit/rn-signer/example/redirect-server/index.ts)
