...
* **Account address** must be specified on the client or per action (`from` or `account`). In v5.x.x, the client automatically uses the signer's address as the account address via [EIP-7702](/docs/wallets/transactions/using-eip-7702).
