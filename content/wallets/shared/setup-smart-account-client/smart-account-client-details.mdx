...
[ModularAccountV2](/docs/wallets/smart-contracts/modular-account-v2/overview) is the recommended smart wallet as it is the cheapest and most advanced option. You can specify other smart wallet types as needed. Learn more about the different smart wallets [here](/docs/wallets/smart-contracts/choosing-a-smart-account).
...
<Tip>
  ...
  [here](/docs/wallets/smart-contracts/modular-account-v2/getting-started).
</Tip>
