The default smart wallet type is Modular Account V2 -- the most cost-effective and advanced smart wallet option. Specify other [account types](#account-type) with additional configuration.
...
[ModularAccountV2](/docs/wallets/smart-contracts/modular-account-v2/overview) is the recommended smart wallet as it is the cheapest and most advanced option. You can specify other smart wallet types as needed. Learn more about [choosing a smart account](/docs/wallets/smart-contracts/choosing-a-smart-account).

* **`type`** (string) - Defines the smart wallet type. Options:
...
<Tip>
  ...
  account type, you'll need to upgrade it. Learn how to [upgrade your account](/docs/wallets/smart-contracts/modular-account-v2/getting-started).
</Tip>
