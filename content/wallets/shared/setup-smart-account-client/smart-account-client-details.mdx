...
Note: React hooks only support Alchemy Signer. If you want to use a 3rd party signer, see this [guide](/docs/wallets/third-party/signers/privy).
...
We recommend using [ModularAccountV2](/docs/wallets/smart-contracts/modular-account-v2/overview) as it is the cheapest and most advanced Smart Account, but you can specify other smart contract account types as needed. Learn more about the different smart accounts [here](/docs/wallets/smart-contracts/choosing-a-smart-account).
...
<Accordion title="Options">
  ...
  | Override fee estimation middleware (if you are using our RPCs, it's important to use the default [`alchemyFeeEstimator`](/docs/wallets/reference/account-kit/infra/variables/alchemyFeeEstimator)) | `feeEstimator`      | `ClientMiddlewareFn`                                                                                                                                                                                                                                                                                 |
