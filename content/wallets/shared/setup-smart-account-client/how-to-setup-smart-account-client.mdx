...
Once users are [authenticated](/docs/wallets/react/quickstart), you can start landing transactions onchain using a Smart Account Client. Setting up a new account client is easy using the `useSmartAccountClient` hook!
