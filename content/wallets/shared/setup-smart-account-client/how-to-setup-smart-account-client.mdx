...
Once users are [authenticated](/docs/wallets/react/getting-started), you can start landing transactions onchain using a Smart Account Client. Setting up a new account client is easy using the `useSmartAccountClient` hook!
