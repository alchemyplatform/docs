...
<Steps>
  <Step title="Find the failed transaction">
    ...
    <img src="https://alchemyapi-res.cloudinary.com/image/upload/v1775586445/docs/aa-sdk/images/wallets/tld-send-failed-filter.png" alt="Transaction Lifecycle Dashboard filtered to Send Failed status" />
  </Step>
  ...
  <Step title="Click Simulate">
    ...
    <img src="https://alchemyapi-res.cloudinary.com/image/upload/v1775582398/docs/aa-sdk/images/wallets/tld-tenderly-simulate.png" alt="Simulate button in the Wallet API Log detail panel" />
  </Step>
