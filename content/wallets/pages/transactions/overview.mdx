...
Sending transactions across EVM and Solana is straightforward with Smart Wallets. This section covers everything you need to know about preparing, signing, sending, and tracking transactions.
...
| [EIP-7702](/docs/wallets/transactions/using-eip-7702)                               | Upgrade embedded EOA users to smart accounts                                   |
