...
Smart Wallets generate signatures that can be validated using [ERC-1271](https://eips.ethereum.org/EIPS/eip-1271). If the wallet is undeployed (also known as a counterfactual address), then the signature is wrapped according to [ERC-6492](https://eips.ethereum.org/EIPS/eip-6492).
