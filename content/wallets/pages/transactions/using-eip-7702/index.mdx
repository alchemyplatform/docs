...
Use `"version": "v1.0.0"` to keep a new account on v1.0.0. You can also pass a supported contract address directly as `delegation`; see [Smart contract deployments](/docs/wallets/smart-contracts/deployed-addresses#modular-account-v2) for the available addresses.
...
<Accordion title="EIP-7702 delegations">
  ...
  Wallet APIs accept the Modular Account v2 contracts listed under [Smart contract deployments](/docs/wallets/smart-contracts/deployed-addresses#modular-account-v2). All other delegation addresses are rejected.
