...
```
  ...
  <Step title="Sign & Send">
    ...
    If the account hasn't been delegated yet, the response type will be `array` containing both an EIP-7702 authorization and a user operation. See [Send Transactions](/docs/wallets/transactions/send-transactions) for a complete example including handling the authorization signature.
  </Step>
</Steps>
