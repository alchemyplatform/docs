...
To bring your own signer, your signer must support signing EIP-7702 authorizations. See the details for the interface requirements [here](/docs/wallets/resources/types#smartaccountsigner).
