...
} // Swap exactly 0.01 USDC

// Mode 2: Get minimum output amount
{
  minimumToAmount: parseEther("0.0001");
} // Get at least 0.0001 ETH. We calculate how much USDC you need to spend to get at least your desired ETH amount.
```
