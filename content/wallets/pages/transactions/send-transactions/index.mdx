...
* For Solana: a Solana signer ([see Solana signer adapters](/docs/wallets/solana/signers)) and a funded wallet to cover fees, or a Solana gas sponsorship policy
...
<Tabs>
  ...
  <Tab title="API" language="typescript">
...
* [Sponsor Solana fees](/docs/wallets/transactions/sponsor-gas/solana)
