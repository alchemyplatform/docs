...
Chains supported (for now) are: Arbitrum, Base, Berachain, Boba Network, BSC/BNB, Celo, Ethereum, Hyperliquid, Ink, Optimism, Plasma, Polygon, Shape, Soneium, DATA Network, Unichain, World Chain, and Zora mainnets.
...
{/* DOCS-218: touched to force preview content sync */}
