...
2. **Admin API**: Create or update policies programmatically with the [Gas Manager Admin API](/docs/wallets/api-reference/gas-manager-admin-api/gas-manager-admin-api-endpoints/gas-manager-admin-api-endpoints)
...
* [Gas Manager Admin API endpoints](/docs/wallets/api-reference/gas-manager-admin-api/gas-manager-admin-api-endpoints/gas-manager-admin-api-endpoints)
