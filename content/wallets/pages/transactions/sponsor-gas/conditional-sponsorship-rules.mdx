...
Basic spending and access limits are supported out of the box without and you can combine multiple controls in one policy. The types of supported rules depend on the policy type.
