...
<Steps>
  <Step title="Open the create policy modal">
    ...
    ![Create policy modal showing the policy type picker](https://alchemyapi-res.cloudinary.com/image/upload/v1786381902/docs/aa-sdk/images/wallets/create-policy-type-picker.png)
  </Step>
  ...
  <Step title="Select chains">
    ...
    ![Create policy modal showing chain selection](https://alchemyapi-res.cloudinary.com/image/upload/v1786381905/docs/aa-sdk/images/wallets/create-policy-select-chains.png)
