...
description: Recommended advanced path for gas sponsorship, with faster confirmations and automatic retries.
subtitle: Recommended, advanced path for gas sponsorship. BSO covers gas for your users' transactions with up to 30% faster execution and automatic retries built in.
slug: wallets/transactions/sponsor-gas/bundler-sponsored-operations
---

## What is Bundler Sponsorship?

Bundler Sponsored Operations (BSO) are the advanced way to cover gas fees for your users' transactions. It's the **recommended default** for new gas sponsorship integrations: BSO lands transactions faster and retries them automatically.
...
## Compute unit costs 
CU cost differ for BSO policies when using low-level APIs.
