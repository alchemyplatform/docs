---
title: Overview
description: Comprehensive guide to authentication methods and user onboarding with Smart Wallets
...
With Smart Wallets, you can solve these challenges by using seamless and familiar login methods while maintaining the security and decentralization benefits of blockchain technology.
...
After authenticating users, generate wallets for them and they can start sending transactions with a few clicks.
