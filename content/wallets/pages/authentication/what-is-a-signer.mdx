...
This doc provides a basic introduction to owners, the criteria to consider when choosing one, and how they integrate with the Smart Wallets SDK.

## Role of an owner

The owner plays a crucial role in your app because it controls the user's smart account. The owner is responsible for:
...
Here are some important criteria to consider when choosing an owner.
