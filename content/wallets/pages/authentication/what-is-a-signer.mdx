...
With Smart Wallets, deploy a **smart wallet** for each user instead of an EOA wallet. This smart wallet stores the user's assets (e.g. tokens or NFTs).
...
The owner plays a crucial role in your app because it controls the user's smart wallet. The owner is responsible for:
