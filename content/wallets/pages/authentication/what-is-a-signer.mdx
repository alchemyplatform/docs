...
Alchemy Signer is supported out of the box with Smart Wallets via easy to use [React Hooks](/docs/wallets/react/quickstart) and lower-lever [SDKs](/docs/wallets/signer/quickstart). Using Smart Wallets with the Alchemy Signer, you can secure your user's account with an email, social login, or passkeys.
