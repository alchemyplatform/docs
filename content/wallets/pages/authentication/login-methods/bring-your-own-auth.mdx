...
<Tabs>
  ...
  <Tab title="API" language="bash">
    ...
    **Pre-generation Response:**
    ...
    <Info>
      The `address` returned is the EOA authentication address. To get the actual wallet address, call the `getAddress()` method on your smart wallet implementation using this address.
    </Info>
