...
Below is a collection of gas benchmarks resulting from the open-source [aa-benchmarks repository.](https://github.com/alchemyplatform/aa-benchmarks/blob/master/README.md) Each of these tables presents the gas costs for specific operations done via transactions -- the key feature of ERC-4337 smart accounts.
...
Take a look at more detailed benchmarks as well as $USD-denominated examples in the [aa-benchmarks README](https://github.com/alchemyplatform/aa-benchmarks/blob/master/README.md).
