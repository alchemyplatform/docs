...
### Make the most of smart accounts

Smart accounts unlock lots of customizable ways to improve the account experience. Still, it requires writing this behavior into the smart contract for the account, which is difficult and security-critical. Modular Account uses the [ERC-6900](https://eips.ethereum.org/EIPS/eip-6900) framework to simplify creating powerful features for smart accounts. Three plugins are included to level up your smart accounts, and you can create your own.

### Multi Owner Plugin

The Multi Owner plugin lets your smart accounts have one or more ECDSA or SCA owners. This allows your account to integrate with multiple owners simultaneously and supports recovering your account if one is lost.
...
Modular Account also supports the same baseline set of smart account features as Light Account: sponsoring gas, batching transactions, rotating owners, and checking ERC-1271 signatures.
