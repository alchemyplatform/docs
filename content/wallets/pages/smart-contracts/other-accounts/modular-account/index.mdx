...
### Make the most of smart wallets

Smart wallets unlock lots of customizable ways to improve the account experience. Still, it requires writing this behavior into the smart contract for the account, which is difficult and security-critical. Modular Account uses the [ERC-6900](https://eips.ethereum.org/EIPS/eip-6900) framework to simplify creating powerful features for smart wallets. Three plugins are included to level up your smart wallets, and you can create your own.

### Multi Owner Plugin

The Multi Owner plugin lets your smart wallets have one or more ECDSA or SCA owners. This allows your account to integrate with multiple owners simultaneously and supports recovering your account if one is lost.

### Session Key Plugin

The Session Key plugin lets your smart wallet add additional signers with specific permissions to your account.
...
Modular Account also supports the same baseline set of smart wallet features as Light Account: sponsoring gas, batching transactions, rotating owners, and checking ERC-1271 signatures.
...
Check out the [plugin development guide](https://www.notion.so/alchemotion/How-to-write-an-ERC-6900-Plugin-8ef518630b1a43a1b301723925407ec5?utm_content=8ef51863-0b1a-43a1-b301-723925407ec5\&utm_campaign=T06RY9YKG\&n=slack\&n=slack_link_unfurl\&pvs=6) if you’re interested.
