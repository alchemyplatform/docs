...
Next, if you want to use a different authentication provider with a smart wallet, check out [choosing an authentication provider](/docs/wallets/signer/what-is-a-signer). Otherwise, if you are ready to get onchain, go to [send transactions](/docs/wallets/transactions/send/send-user-operations).
