...
Next, if you want to use a different `signer` with a smart account signer, check out [choosing a signer](/docs/wallets/signer/what-is-a-signer). Otherwise, if you are ready to get on-chain, go to [send user operations](/docs/wallets/transactions/send/send-user-operations).
