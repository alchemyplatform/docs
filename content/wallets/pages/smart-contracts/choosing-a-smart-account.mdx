...
A clean SDK is available to provide your users with top-tier ERC-4337 smart wallet features. The most powerful, most natively-supported account is Modular Account V2.

MAv2 is the most fully-featured and efficient smart wallet available, allowing for limitless modular expansion. The account is secured by extensive [audits](https://github.com/alchemyplatform/modular-account/tree/develop/audits) as well as a [bug bounty on Cantina.](https://cantina.xyz/bounties/246de4d3-e138-4340-bdfc-fc4c95951491)
...
MAv2 also supports [EIP-7702](https://github.com/ethereum/EIPs/blob/master/EIPS/eip-7702.md) out of the box, allowing EOAs to seamlessly turn into maximally expandable smart wallets.

## Other smart wallets

While **MAv2** is the recommended choice, other audited and gas-optimized ERC-4337 smart wallet implementations are also supported:
