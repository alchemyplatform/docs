...
A clean SDK is available to provide your users with top-tier ERC-4337 smart account features. The most powerful, most natively-supported account is Modular Account V2.

MAv2 is the most fully-featured and efficient smart account available, allowing for limitless modular expansion. The account is secured by extensive [audits](https://github.com/alchemyplatform/modular-account/tree/develop/audits) as well as a [bug bounty on Cantina.](https://cantina.xyz/bounties/246de4d3-e138-4340-bdfc-fc4c95951491)

MAv2 also strives to be maximally gas-efficient, being the **only** account where runtime deployment breaks the **sub-100k gas barrier**, which is cheaper than *one Uniswap swap*. For more details around MAv2 and benchmarks, check out the [MAv2 overview](/docs/wallets/smart-contracts/modular-account-v2/overview).
...
While **MAv2** is the recommended choice, other audited and gas-optimized ERC-4337 smart account implementations are also supported:

### [Light Account](/docs/wallets/smart-contracts/other-accounts/light-account)
...
### [Multi-Owner Light Account](/docs/wallets/smart-contracts/other-accounts/light-account)
...
See the guide on [using a custom smart account](/docs/wallets/third-party/smart-contracts).
