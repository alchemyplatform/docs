...
Once you get the `paymaster` and `paymasterData` fields, you can use them in your userOp when you call [`eth_sendUserOperation`](/docs/reference/eth-senduseroperation). The Gas Manager will pay for the gas of the userOp when it is mined.
