...
Once you get the `paymaster` and `paymasterData` fields, you can use them in your userOperation when you call [`eth_sendUserOperation`](https://www.alchemy.com/docs/wallets/api/bundler-api/bundler-api-endpoints/eth-send-user-operation). You can find an example script below.
