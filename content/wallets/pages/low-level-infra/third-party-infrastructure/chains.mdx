...
See [`createSmartAccountClient`](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/aa-sdk/core/src/functions/createSmartAccountClient.mdx) for more information.
