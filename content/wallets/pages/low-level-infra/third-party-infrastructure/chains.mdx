...
For smart account only chains, the `alchemyTransport` allows you to specify both the connection object as well as pass in a Node RPC URL, allowing you to split traffic between the bundler and gas sponsorship RPC and your Node RPC provider.
