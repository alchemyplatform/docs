...
3. **Create the policy**: Next, make a request to the [Create Policy](/docs/reference/create-policy) endpoint with your policy rules.

## Methods

| Method                                                  | Description                                                                                                                                   |
| ------------------------------------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------- |
| [Create Policy](/docs/reference/create-policy)               | Creates a new gas manager policy with the specified rules. Returns the policy id of a successfully created policy.                            |
| [Get Policy](/docs/reference/get-policy)                     | Returns policy information by id.                                                                                                             |
| [Delete Policy](/docs/reference/delete-policy)               | Deletes a policy by id.                                                                                                                       |
| [Replace Policy](/docs/reference/replace-policy)             | Accepts a rules object and replaces all rules in an existing policy by id.                                                                    |
| [Get All Policies](/docs/reference/get-all-policies)         | Accepts an app id and returns all policies under that app.                                                                                    |
| [Update Policy Status](/docs/reference/update-policy-status) | Modifies the status of a policy to either "active" or "inactive".                                                                             |
| [Get Policy Stats](/docs/reference/get-policy-stats)         | Returns stats about a policy specified by ID, including signatures mined, signatures expired, signatures pending, USD mined, and USD pending. |
| [Get Sponsorships](/docs/reference/get-sponsorships)         | Returns a list of sponsorships associated with the specified policy ID. The results are paginated.                                            |
