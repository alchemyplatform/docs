...
Session keys work best when they are tightly scoped. Smart Wallets gives you a flexible set of built-in permission types. These permissions are validated onchain removing any dependency on an offchain engine and increasing security of users' wallets.
...
Supports limiting what functions a key may call on the smart account (e.g. installing or uninstalling modules, or upgrading the account)
