...
**Smart Wallets** enable seamless crypto experiences with gas sponsorship, batched transactions, and chain abstraction. Secured by non-custodial Trusted Execution Environments (TEEs) and enterprise-grade audited smart accounts, they protect user assets with both offchain and onchain safeguards.

Policies allow you to set rules and constraints governing how smart accounts operate, ensuring security and control over onchain actions. Using the policy dashboard, configure rules such as spending limits, contract allowlists, or denylists. This overview explains how to leverage policies to further secure your smart account.

**Key Features:**

* **Granular control**: Define allowable actions, such as approved contracts or maximum transfer amounts.
* **Scalability**: Policies are built on high-performance RPC and gas sponsorship systems, ensuring seamless operation at scale.
* **Composable Security:** Policies can be defined onchain or offchain and seamlessly composed to authorize smart account operations to multi-layer beyond standard authentication mechanisms.

<img src="https://alchemyapi-res.cloudinary.com/image/upload/v1764187318/docs/aa-sdk/images/smart-wallet-transaction-policies.png" alt="smart wallet transaction policies" />

## Offchain policies (EVM & Solana)

Offchain policies shift rule enforcement to offchain infrastructure. In EVM, these policies can also be composed with the onchain policies to provide multi-layered security.
...
Session keys allow you to add multiple owners to a smart account with scoped permissions that are validated onchain. This unlocks:

* Multiple owners for smart accounts
...
> Want to build your own permission system? Modular Account v2 is designed to plug in custom modules.
