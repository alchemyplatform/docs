...
Smart Wallets offers a clean SDK to provide your users with top-tier smart account features. The most powerful, most natively-supported account is Modular Account v2.
...
While Modular Account v2 is the recommended choice, Smart Wallets also supports other audited and gas-optimized smart account implementations.
