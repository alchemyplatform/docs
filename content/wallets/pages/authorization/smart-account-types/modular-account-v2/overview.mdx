...
Find open-source benchmarks [here](https://github.com/alchemyplatform/aa-benchmarks).
...
EIP-7702 is an Ethereum upgrade that enables Externally Owned Accounts (EOAs) to use smart account features.

Create an EIP-7702 compliant version of a Modular Account V2, learn how to [here](/docs/wallets/transactions/using-eip-7702).
