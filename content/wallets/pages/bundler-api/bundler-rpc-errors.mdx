...
Field names below reflect what the Alchemy bundler ([Rundler](https://github.com/alchemyplatform/rundler)) actually serializes. If a code is emitted without a `data` object, the useful context is included in the top-level `message` string instead.
