---
title: EntryPoint v0.8 Revert Codes
description: Learn about the revert codes returned by the ERC-4337 EntryPoint v0.8
subtitle: Learn about the revert codes returned by the ERC-4337 EntryPoint v0.8
url: https://alchemy.com/docs/wallets/reference/entrypoint-v08-revert-codes
slug: wallets/reference/entrypoint-v08-revert-codes
---
