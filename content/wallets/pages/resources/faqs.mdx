...
<Accordion title="Answer">
  ...
  [`getAccountInitCode`](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/aa-sdk/core/src/functions/toSmartContractAccount.mdx).
</Accordion>
...
<Accordion title="Answer">
  ...
  ***
  ...
  1. The frontend generates a stamped request using [signer.inner.stampWhoAmI](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/account-kit/signer/src/classes/BaseSignerClient.mdx#stampwhoami).
...
<Accordion title="Answer">
  ...
  You can mitigate this by defining a more flexible retry period when constructing a [`Client`](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/aa-sdk/core/src/functions/createSmartAccountClient.mdx) (i.e. `txMaxRetries`, `txRetryIntervalMs`, `txRetryMultiplier` in `opts`).

  If your `UserOperation` continues to be delayed beyond a limit you are willing to wait, you can resubmit the user operation using [`dropAndReplaceUserOperation`](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/aa-sdk/core/src/functions/dropAndReplaceUserOperation.mdx#usage).
</Accordion>
...
[Reference: createConfig](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/account-kit/react/src/functions/createConfig.mdx)
