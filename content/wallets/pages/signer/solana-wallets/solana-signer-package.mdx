...
If you're not using React, use the `@account-kit/signer` package to create smart accounts on Solana, sign messages, sign transactions, and sponsor transaction fees.
