...
Smart Wallet Policies are programmatic rules enforced through the offchain policy engine and/or onchain smart contract modules. They govern how a smart wallet interacts with the blockchain, from transaction execution to owner permissions. Unlike traditional embedded wallets, Smart Wallets allow you to embed logic that restricts or automates behavior verifiably onchain.
