...
Smart Wallet Policies are programmatic rules enforced through the offchain policy engine and/or onchain smart contract modules. They govern how a smart wallet interacts with the blockchain, from transaction execution to owner permissions. Unlike traditional embedded wallets, you can embed logic that restricts or automates behavior verifiably onchain.
...
5. **Time Restrictions**
   * Description: Enable time based restrictions for transactions through a smart wallet.
...
10. **Chain Restrictions (Offchain)**
    * Description: Restrict a smart wallet to only transact on a limited set of chains.
