...
With Smart Wallets, you deploy a **smart account** for each user instead of an EOA wallet. This smart account stores the user’s assets (e.g. tokens or NFTs).
...
The authentication provider plays a crucial role in your app because it controls the user’s smart account. It is responsible for:
