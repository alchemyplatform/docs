...
<Tip>
The OTP email flow is recommended instead, as it is more reliable across different browser environments. OTP flows have also been shown to have up to a 3x higher conversion rate and a 10-second faster flow compared to magic link.
...
<Tip>
  ...
  Quickstart](/docs/wallets/signer/quickstart).
</Tip>
