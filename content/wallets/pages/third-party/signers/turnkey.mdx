...
<Tabs>
  <Tab title="React" language="react">
    ...
    <CodeGroup>
    ```shell npm
    npm install @alchemy/wallet-apis@0.0.0-alpha.21 @turnkey/react-wallet-kit @turnkey/viem viem
    ```

    ```shell bun
    bun add @alchemy/wallet-apis@0.0.0-alpha.21 @turnkey/react-wallet-kit @turnkey/viem viem
    ```

    ```shell yarn
    yarn add @alchemy/wallet-apis@0.0.0-alpha.21 @turnkey/react-wallet-kit @turnkey/viem viem
    ```

    ```shell pnpm
    pnpm add @alchemy/wallet-apis@0.0.0-alpha.21 @turnkey/react-wallet-kit @turnkey/viem viem
    ```
    </CodeGroup>
  ...
  <Tab title="JavaScript" language="typescript">
    ...
    <CodeGroup>
    ```shell npm
    npm install @turnkey/sdk-server @turnkey/viem @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```

    ```shell bun
    bun add @turnkey/sdk-server @turnkey/viem @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```

    ```shell yarn
    yarn add @turnkey/sdk-server @turnkey/viem @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```

    ```shell pnpm
    pnpm add @turnkey/sdk-server @turnkey/viem @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```
    </CodeGroup>
