...
<Tabs>
  <Tab title="React" language="react">
    ...
    <CodeGroup>
    ```shell npm
    npm install @alchemy/wallet-apis@0.0.0-alpha.21 @privy-io/react-auth viem
    ```

    ```shell bun
    bun add @alchemy/wallet-apis@0.0.0-alpha.21 @privy-io/react-auth viem
    ```

    ```shell yarn
    yarn add @alchemy/wallet-apis@0.0.0-alpha.21 @privy-io/react-auth viem
    ```

    ```shell pnpm
    pnpm add @alchemy/wallet-apis@0.0.0-alpha.21 @privy-io/react-auth viem
    ```
    </CodeGroup>
  ...
  <Tab title="JavaScript" language="typescript">
    ...
    <CodeGroup>
    ```shell npm
    npm install @privy-io/node @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```

    ```shell bun
    bun add @privy-io/node @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```

    ```shell yarn
    yarn add @privy-io/node @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```

    ```shell pnpm
    pnpm add @privy-io/node @alchemy/wallet-apis@0.0.0-alpha.21 viem
    ```
    </CodeGroup>
