...
<Tabs>
  ...
  <Tab title="JavaScript" language="typescript">
    ...
    * The client defaults to [EIP-7702](/wallets/transactions/using-eip-7702), which upgrades the wallet to a smart account at transaction time without migration or separate deployment. See the [EIP-7702 guide](/wallets/transactions/using-eip-7702) for non-7702 mode.
    * See the [Sponsor gas](/wallets/transactions/sponsor-gas) guide for more on gas sponsorship configuration.
