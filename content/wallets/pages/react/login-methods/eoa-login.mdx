...
* EVM EOAs behave as regular wallets (no smart account features like sponsorship).
* You can optionally use an EVM EOA as a smart account owner to unlock smart account features like sponsorship and batching.
...
## Bring in an EOA as a smart account owner

For local wallets or JSON-RPC wallets that support the [EIP-1193](https://eips.ethereum.org/EIPS/eip-1193) standard (like MetaMask, Coinbase Wallet, etc.), you can use `WalletClientSigner` from `@aa-sdk/core` to bring in these EOAs as your smart account owner. More info [here](https://www.alchemy.com/docs/wallets/third-party/signers/privy).
By making your EOA an owner of a smart account, you gain access to smart account features.
