...
Use the [useConnect](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/account-kit/react/src/functions/useConnect.mdx) hook to allow users to connect their EOA via available connectors:
