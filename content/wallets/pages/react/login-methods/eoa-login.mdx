...
Connectors let users authenticate with existing **external wallets**. Smart Wallets supports both **EVM** (e.g., MetaMask, Coinbase, WalletConnect) and **Solana** (e.g., Phantom) wallets via UI components or custom UI, and can surface them together in your auth modal.
...
By making your EOA an owner of a smart account, you gain access to smart wallet features through your new smart wallet.
