...
If you want to connect to a user’s Solana Wallet and send transactions, you should use the [`useSolanaTransaction`](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/account-kit/react/src/functions/useSolanaTransaction.mdx) hook. This hook also exposes the Solana wallet address through the `signer.address` parameter.
