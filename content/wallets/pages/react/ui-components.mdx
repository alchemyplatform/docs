...
That's it! When the user clicks that button, the modal will open and they can complete authentication. Once they are authenticated, you can use the [`useAccount`](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/account-kit/react/src/functions/useAccount.mdx) hook to get the logged in user's SCA address.
...
That's it! The user can now input their credentials and complete login. Once they are authenticated, you can use the [`useAccount`](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/account-kit/react/src/functions/useAccount.mdx) hook to get the logged in user's SCA address.
