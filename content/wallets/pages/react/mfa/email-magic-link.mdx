...
### Step 1: Initialize authentication and handle MFA
...
### Step 2: Submit TOTP code and complete auth

Once you have the MFA data from the first step, complete the authentication by submitting the TOTP code with the multiFactorId.
