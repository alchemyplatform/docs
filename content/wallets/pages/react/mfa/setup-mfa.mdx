...
<Tabs>
  <Tab title="React" language="react">
    ...
    1. **Set up primary authentication** - MFA requires a primary authentication method to be already set up. Follow the [React Overview](/docs/wallets/react/quickstart) guide to configure email (OTP or magic link) or social login.
