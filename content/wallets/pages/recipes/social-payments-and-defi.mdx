...
description: Build a social payments and DeFi app with Smart Wallets, featuring email signup, username-based transfers, and yield earning.
slug: wallets/recipes/social-payments-and-defi
---

Below are two versions of a demo social payments and DeFi application called **ChainMoney**.
...
The first version below uses Smart Wallets react hooks and built-in auth components while the second uses Wallet APIs to do everything on the backend.

## ChainMoney using Smart Wallets

This version of the ChainMoney demo app uses the [React hooks](/docs/wallets/reference/account-kit/react) and built-in auth components.
...
This version of the ChainMoney demo app uses the [wallet APIs](/docs/wallets/api-reference/smart-wallets/wallet-api-endpoints/wallet-api-endpoints/wallet-request-account) on the backend.
