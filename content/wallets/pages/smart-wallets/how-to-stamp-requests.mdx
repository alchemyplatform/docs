...
2. Generate a private key bundle
   ...
   1. Exchange the `targetPublicKey` for an encrypted `bundle` by calling [create wallet](https://github.com/alchemyplatform/aa-sdk/blob/v4.x.x/docs/pages/reference/account-kit/core/src/functions/createAccount.mdx) (e.g., OAuth, email login)
