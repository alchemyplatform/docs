...
**Using React or Vanilla JS?** Use our [Account Kit SDK](/docs/wallets) to create and use wallets. The SDK handles all signing and authentication complexity for you, making development faster and easier. We provide an [SDK](https://github.com/alchemyplatform/aa-sdk) in React, Vanilla Typescript, and (soon) Java.

If you want to use APIs directly, please first see [this guide](/docs/reference/how-to-stamp-requests) for implementing custom logic to send stamped requests.
