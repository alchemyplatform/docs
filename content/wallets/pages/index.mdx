...
<CardGroup cols={2}>
  ...
  <Card title="Automatic retries" icon="fa-solid fa-arrows-rotate" href="/docs/wallets/transactions/retry-transactions">
...
<CardGroup cols={3}>
  ...
  <Card title="FAQs" icon="fa-solid fa-circle-info" href="/docs/wallets/resources/faqs">
