...
<CardGroup cols={2}>
  <Card title="React Quickstart" icon="bolt" href="/docs/wallets/react/quickstart">
    Build an onchain app from scratch with wallets and transactions.
  </Card>
  <Card
    title="Quickstart"
    icon="fa-solid fa-play"
    href="/docs/wallets/react/getting-started"
  >
    Get started building with Smart Wallets.
  </Card>
</CardGroup>
