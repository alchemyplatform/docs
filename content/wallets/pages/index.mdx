...
<CardGroup cols={4}>
  ...
  <Card title="Javascript" icon="fa-brands fa-js" href="/docs/wallets/quickstart">
...
<CardGroup cols={2}>
  <Card title="Build a new app" icon="wrench" href="/docs/wallets/quickstart">
