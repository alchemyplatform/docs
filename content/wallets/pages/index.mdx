...
<CardGroup cols={2}>
  ...
  <Card title="Automatic retries" icon="fa-solid fa-arrow-right" href="/docs/wallets/transactions/retry-transactions">
  ...
  <Card title="Track status" icon="fa-solid fa-eye" href="/docs/wallets/api-reference/smart-wallets/wallet-api-endpoints/wallet-api-endpoints/wallet-get-calls-status">
