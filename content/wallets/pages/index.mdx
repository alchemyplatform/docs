...
<CardGroup cols={4}>
  <Card title="1. Prepare" icon="file-code">
    Build one or more calls - transfer, swap, — anything.
  </Card>

  <Card title="2. Sign" icon="key">
  ...
  <Card title="4. Track" icon="magnifying-glass">
...
<CardGroup cols={2}>
  ...
  <Card title="Automatic retries" icon="rotate" href="/docs/wallets/transactions/retry-transactions">
  ...
  <Card title="Parallel transactions" icon="code-fork" href="/docs/wallets/transactions/send-parallel-transactions">
  ...
  <Card title="EIP-7702" icon="arrow-up" href="/docs/wallets/transactions/sponsor-gas/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Other signers" icon="plug" href="/docs/wallets/third-party/signers/custom-integration">
...
<CardGroup cols={3}>
  ...
  <Card title="FAQs" icon="circle-question" href="/docs/wallets/resources/faqs">
    Common questions and troubleshooting.
  </Card>

  <Card title="Contact us" icon="envelope" href="/docs/wallets/resources/contact-us">
