...
<CardGroup cols={4}>
  <Card title="1. Prepare" icon="fa-solid fa-file-code">
    Build one or more calls - transfer, swap, — anything.
  </Card>

  <Card title="2. Sign" icon="fa-solid fa-key">
  ...
  <Card title="4. Track" icon="fa-solid fa-magnifying-glass">
...
<CardGroup cols={2}>
  ...
  <Card title="Solana sponsorship" icon="fa-solid fa-gas-pump" href="/docs/wallets/transactions/solana/sponsor-gas">
  ...
  <Card title="Automatic retries" icon="fa-solid fa-rotate" href="/docs/wallets/transactions/retry-transactions">
    Stuck transactions are automatically re-priced and resubmitted so they
    land on-chain.
  </Card>

  <Card title="Session keys" icon="fa-solid fa-clock" href="/docs/wallets/transactions/grant-session-keys">
    Grant scoped, time-limited signing permissions for autonomous signing. 
  </Card>

  <Card title="Parallel transactions" icon="fa-solid fa-arrows-split-up-and-left" href="/docs/wallets/transactions/send-parallel-transactions">
  ...
  <Card title="Track status" icon="fa-solid fa-bug" href="/docs/wallets/api-reference/smart-wallets/wallet-api-endpoints/wallet-api-endpoints/wallet-get-calls-status">
  ...
  <Card title="EIP-7702" icon="fa-solid fa-arrow-right-arrow-up" href="/docs/wallets/transactions/sponsor-gas/overview">
...
<CardGroup cols={2}>
  ...
  <Card title="Other signers" icon="fa-solid fa-plug" href="/docs/wallets/third-party/signers/custom-integration">
...
<CardGroup cols={3}>
  ...
  <Card title="Recipes" icon="fa-solid fa-book" href="/docs/wallets/recipes">
  ...
  <Card title="FAQs" icon="fa-solid fa-circle-question" href="/docs/wallets/resources/faqs">
    Common questions and troubleshooting.
  </Card>

  <Card title="Contact us" icon="fa-solid fa-envelope" href="/docs/wallets/resources/contact-us">
