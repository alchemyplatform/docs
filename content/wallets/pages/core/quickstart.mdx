...
To get started, install the required packages. The `infra` package contains the necessary `Chain` definitions that make it easier to set up
your client.
...
3. Create a policy in the [Gas Sponsorship dashboard](/docs/wallets/transactions/sponsor-gas/sponsorship-policy-management) to set rules for sponsorship.
...
Now that you have basic authentication and transactions working, explore additional features:
