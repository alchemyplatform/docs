...
<div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start" }}>
  <div style={{ flex: "1", marginRight: "10px" }}>
    With Smart Wallets, deploy a **smart account** for
...
<div style={{ display: "flex", flexWrap: "wrap", alignItems: "flex-start" }}>
  <div style={{ flex: "1", marginRight: "10px" }}>
    An **owner** is a service (e.g., Turnkey or Magic) or application (e.g., MetaMask) that manages a private key and signs transactions. The signature is only valid if the owner is an owner of the smart account.
  </div>
...
In Smart Wallets, this concept will manifest as an [owner](/docs/wallets/signer/what-is-a-signer).
