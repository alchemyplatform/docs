...
<Tip>
  ...
  [Infra](https://github.com/alchemyplatform/aa-sdk/tree/v4.x.x/docs/pages/reference/account-kit/infra) packages, the Smart Account
...
2. `feeEstimator` - Estimates the fees for a transaction. If you are using Wallet APIs RPCs, use the [`alchemyFeeEstimator`](https://github.com/alchemyplatform/aa-sdk/tree/v4.x.x/docs/pages/reference/account-kit/infra) middleware.
