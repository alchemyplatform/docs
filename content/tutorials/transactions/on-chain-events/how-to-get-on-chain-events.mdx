...
To get the event logs, we will use the [getLogs](/docs/reference/sdk-getlogs) method. Which takes in an object as a parameter with the properties defined in [parameters](#parameters).
