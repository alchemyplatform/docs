...
To get the Transaction Receipt, we will use the [getTransactionReceipt](/docs/reference/sdk-gettransactionreceipt) method which takes in the string of the transaction hash as the parameter.
