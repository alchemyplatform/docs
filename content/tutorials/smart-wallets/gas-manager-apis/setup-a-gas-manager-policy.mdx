...
1. Retrieve your policy id and get your supported entry points via [`eth_supportedEntryPoints`](/docs/wallets/api/bundler-api/bundler-api-endpoints/eth-supported-entry-points).
...
3. Use the returned `paymasterAndData` in the final user operation and submit it to a bundler using [`eth_sendUserOperation`](/docs/wallets/api/bundler-api/bundler-api-endpoints/eth-send-user-operation).
