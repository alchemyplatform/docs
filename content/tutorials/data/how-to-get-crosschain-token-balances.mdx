...
* **Add NFTs** — pair with [`getNFTsForOwner`](https://www.alchemy.com/docs/reference/nft-api-endpoints/nft-api-endpoints/nft-ownership-endpoints/get-nf-ts-for-owner-v-3) for a full wallet portfolio view that includes non-fungible tokens.
