...
This guide explains how data is stored on smart contracts. Contract storage layout refers to the rules governing how contracts’ storage variables are laid out in long-term memory.
...
### Why contracts have such large storage
...
## State variable storage in slots
...
## State variable padding and packing
...
An example of this is shown in the **PackedContract** below, which is a reordering of the variables in the **PaddedContract** example:
...
## Struct storage in contract memory
...
## Dynamic variable storage in memory
...
* for strings and byte arrays, h() returns the unpadded data
