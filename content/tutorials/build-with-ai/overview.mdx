---
title: Build with AI
description: Give your AI agent knowledge of Alchemy APIs with agent skills, query live onchain data through MCP, and authenticate autonomously with Alchemy for Agents.
subtitle: Give your AI agent knowledge of Alchemy APIs with agent skills, query live onchain data through MCP, and authenticate autonomously with Alchemy for Agents.
...
[Learn about Alchemy for Agents →](docs/alchemy-for-agents)
...
| Build an autonomous agent that authenticates with a wallet and pays with USDC | [Agent Skills](docs/alchemy-agent-skills) + [Alchemy for Agents](docs/alchemy-for-agents) |
