...
| Build an autonomous agent that authenticates with a wallet and purchases credits with USDC | [Agent Skills](docs/alchemy-agent-skills) + [Alchemy for Agents](docs/alchemy-for-agents) |
