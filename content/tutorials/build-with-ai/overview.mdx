...
* 148 blockchain tools including token prices, NFT data, transaction history, simulation, tracing, account abstraction, Solana DAS, and more
* 100+ supported chains
* Works with Claude Code, Claude Desktop, Cursor, VS Code Copilot, Windsurf, Codex, Cline, and any MCP-compatible client
