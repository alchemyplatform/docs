...
Authenticate your AI agent with an EVM or Solana wallet instead of an API key using [SIWE (Sign-In With Ethereum)](https://eips.ethereum.org/EIPS/eip-4361) and [SIWS (Sign-In With Solana)](https://phantom.com/learn/developers/sign-in-with-solana). Your agent purchases credits with USDC via the [x402 payment protocol](https://www.x402.org/), with no human in the loop.
