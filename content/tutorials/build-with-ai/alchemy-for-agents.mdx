...
The [Alchemy CLI](docs/alchemy-cli) ships the same x402 flow built in. Point the CLI at a local wallet key, opt into x402, and node and data commands bill from your wallet without an API key.
