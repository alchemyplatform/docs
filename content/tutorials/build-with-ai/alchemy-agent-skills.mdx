...
description: Install Alchemy's agent skills to give your AI coding agent full knowledge of Alchemy's APIs, with API key or wallet-based authentication.
subtitle: Install Alchemy's agent skills to give your AI coding agent full knowledge of Alchemy's APIs, with API key or wallet-based authentication.
...
- **Purchase credits:** your agent buys credits with USDC from your wallet. When credits run out, your agent purchases more automatically
...
For a full walkthrough of the authentication and payment flow, see [Alchemy for Agents](docs/alchemy-for-agents).
