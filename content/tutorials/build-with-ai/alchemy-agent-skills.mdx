...
- **Pay per request:** if the server returns HTTP 402, your agent pays with USDC and retries automatically
...
For a full walkthrough of the authentication and payment flow, see [x402 wallet authentication](docs/alchemy-for-agents).
...
- [x402 wallet authentication](docs/alchemy-for-agents)
