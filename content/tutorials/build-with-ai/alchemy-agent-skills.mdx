...
Skills work with [Claude Code](https://www.anthropic.com/claude-code), [Codex](https://openai.com/index/codex/), [Cursor](https://cursor.com), [VS Code Copilot](https://code.visualstudio.com/docs/setup/copilot), and any AI tool that supports the [Agent Skills specification](https://agentskills.io).
...
* **Portfolio API:** Multi-chain token balances, NFT data, and transfer history
