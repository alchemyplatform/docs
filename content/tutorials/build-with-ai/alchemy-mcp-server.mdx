...
Want to run the MCP server locally or contribute? Check out the source on GitHub: [alchemyplatform/alchemy-mcp-server](https://github.com/alchemyplatform/alchemy-mcp-server).
