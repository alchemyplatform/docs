...
The [Shape snapshot service](https://alchemy.com/snapshots/shape) is available for bootstrapping your node.
...
Go to our [Shape snapshot service](https://alchemy.com/snapshots/shape) and download the latest available snapshot. Decompress the archive as per the following instructions and start your node.
