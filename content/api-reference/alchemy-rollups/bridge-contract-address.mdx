...
The bridge contract address facilitates communication and asset transfers between Layer 1 (L1) and your Arbitrum rollup (L2). To bridge funds, follow these steps:
