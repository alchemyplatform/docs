...
description: Stream block, transaction, address, and fiat rate updates from Dogecoin over a persistent WebSocket connection.
subtitle: Real-time UTXO event streams over WebSockets
slug: docs/dogecoin/utxo-websockets
---
