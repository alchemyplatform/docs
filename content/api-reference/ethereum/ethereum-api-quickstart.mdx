...
* [Ethereum Developer Guide to the Merge](/docs/ethereum-developer-guide-to-the-merge)
* [How do I distinguish between a contract address and wallet address?](/docs/reference/contract-address-vs-wallet-address)
