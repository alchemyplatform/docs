...
subtitle: Everything you need to know as an Ethereum developer to prepare for The Merge.
...
* [eth\_getBlockByNumber](/docs/reference/eth-getblockbynumber)
* [eth\_getLogs](/docs/reference/eth-getlogs)
* [eth\_getBlockTransactionCountByNumber](/docs/chains/ethereum/ethereum-api-endpoints/eth-get-block-transaction-count-by-number)
* [eth\_getTransactionCount](/docs/reference/eth-gettransactioncount)
* [eth\_getTransactionByBlockHashAndIndex](/docs/chains/ethereum/ethereum-api-endpoints/eth-get-transaction-by-block-hash-and-index)
* [eth\_getBlockReceipts](/docs/reference/eth-getblockreceipts)
* [eth\_getBalance](/docs/reference/eth-getbalance)
* [eth\_getCode](/docs/reference/eth-getcode)
* [eth\_estimateGas](/docs/reference/eth-estimategas)
* [eth\_getUncleByBlockNumberAndIndex](/docs/chains/ethereum/ethereum-api-endpoints/eth-get-uncle-by-block-number-and-index)
* [eth\_call](/docs/reference/eth-call)
* [trace\_call](/docs/reference/trace-call)
* [trace\_replayBlockTransactions](/docs/reference/trace-replayblocktransactions)
* [trace\_block](/docs/reference/trace-block)
