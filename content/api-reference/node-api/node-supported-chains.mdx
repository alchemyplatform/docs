...
<CardGroup cols={3}>
  ...
  <Card title="Robinhood Chain" icon={<img src="https://alchemyapi-res.cloudinary.com/image/upload/v1784744111/docs/api-reference/node-api/robinhood-mainnet_azy7z0.svg" alt="Robinhood Chain logo" style={{width: "24px"}}/>} href="/docs/reference/robinhood-chain-api-quickstart">
