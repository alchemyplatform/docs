...
<CardGroup cols={3}>
  ...
  <Card title="DATA Network" icon={<img src="https://alchemyapi-res.cloudinary.com/image/upload/v1764180079/docs/api-reference/node-api/Story.svg" alt="DATA Network logo"/>} href="/docs/reference/story-api-quickstart">
