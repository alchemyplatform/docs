...
The Story API provides interaction with the Story network through a set of JSON-RPC methods. If you've worked with Ethereum's JSON-RPC APIs, you'll find the interface familiar.
