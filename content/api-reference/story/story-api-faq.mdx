...
The DATA Network API lets you interface with the DATA Network mainnet and testnet (DATA Network Aeneid) nodes. You can execute transactions, query onchain data, and interact with the DATA Network using the JSON-RPC standard.

## How can I get started using the DATA Network API?

Explained in [DATA Network API Quickstart](/docs/reference/story-api-quickstart)
