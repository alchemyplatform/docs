...
Alchemy proxies Jito's [low-latency bundle methods](/docs/chains/solana/solana-jito-bundles-and-transactions) on the standard Solana RPC endpoint. Bundles execute atomically and sequentially, with a tip to one of the Jito tip accounts required for inclusion.
