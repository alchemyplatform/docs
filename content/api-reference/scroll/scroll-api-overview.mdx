...
| [`eth_newFilter`](/docs/chains/scroll/scroll-api-endpoints/eth-new-filter)                      | [`eth_newPendingTransactionFilter`](/docs/chains/scroll/scroll-api-endpoints/eth-new-pending-transaction-filter) |
| [`eth_protocolVersion`](/docs/chains/scroll/scroll-api-endpoints/eth-protocol-version)          | [`eth_sendRawTransaction`](/docs/chains/scroll/scroll-api-endpoints/eth-send-raw-transaction) |
