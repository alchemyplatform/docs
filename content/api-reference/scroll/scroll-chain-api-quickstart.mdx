...
<Warning title="Scroll Sepolia testnet deprecation">
  Support for the **Scroll Sepolia** testnet ends on **July 30, 2026**. The Scroll team is shutting down the Scroll Sepolia testnet. See the [Scroll Sepolia Deprecation Notice](/docs/reference/scroll-sepolia-deprecation-notice) for details. Scroll Mainnet remains fully supported.
</Warning>
