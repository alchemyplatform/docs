...
Alchemy proxies four of [Jito's](https://docs.jito.wtf/lowlatencytxnsend/#bundles-api-v1) low-latency bundle methods on the Solana endpoint. Bundles are groups of up to 5 transactions that execute sequentially and atomically (all-or-nothing) in a single slot. A tip to one of the [`getTipAccounts`](/docs/chains/solana/solana-api-endpoints/get-tip-accounts) pubkeys is required for a bundle to be considered by the block engine (minimum 1,000 lamports).

|                                                                                                 |                                                                                             |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [`sendBundle`](/docs/chains/solana/solana-api-endpoints/send-bundle)                            | [`getBundleStatuses`](/docs/chains/solana/solana-api-endpoints/get-bundle-statuses)         |
| [`getTipAccounts`](/docs/chains/solana/solana-api-endpoints/get-tip-accounts)                   | [`getInflightBundleStatuses`](/docs/chains/solana/solana-api-endpoints/get-inflight-bundle-statuses) |
