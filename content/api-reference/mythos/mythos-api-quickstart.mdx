---
title: Mythos API Quickstart
description: How to get started building on Mythos and using the JSON-RPC API
subtitle: How to get started building on Mythos and using the JSON-RPC API
slug: reference/mythos-api-quickstart
---
...
The Mythos API allows interaction with the Mythos network through a set of JSON-RPC methods. Its design is familiar to developers who have worked with Ethereum's JSON-RPC APIs, making it intuitive and straightforward to use.
...
Congratulations! You've made your first request to the Mythos network. You can now explore the various JSON-RPC methods available on Mythos and start building your dApps on this innovative platform.
