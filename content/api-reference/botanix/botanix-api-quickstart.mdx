...
<Warning title="Botanix deprecation">
  The Botanix team is shutting down Botanix Mainnet and Testnet. Alchemy will fully deprecate support for **Botanix Mainnet** (`botanix-mainnet`) and **Botanix Testnet** (`botanix-testnet`) on **August 1, 2026**. See the [Botanix Deprecation Notice](/docs/reference/botanix-deprecation-notice) for details.
</Warning>
