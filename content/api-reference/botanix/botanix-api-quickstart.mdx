...
<Warning title="Botanix deprecation">
  Botanix is shutting down. Alchemy support for **Botanix Mainnet** (`botanix-mainnet`) and **Botanix Testnet** (`botanix-testnet`) ends on **August 1, 2026**. See the [Botanix Deprecation Notice](/docs/reference/botanix-deprecation-notice) for details.
</Warning>
