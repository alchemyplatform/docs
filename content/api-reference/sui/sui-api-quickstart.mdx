...
Well done! You've just made your first request to the Sui App API. With this foundation, you can dive deeper into the array of [JSON-RPC methods available on Sui App](/docs/reference/sui-api-quickstart) and start building your dApps on it!
