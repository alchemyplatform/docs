...
description: Stream block, transaction, address, and fiat rate updates from Litecoin over a persistent WebSocket connection.
subtitle: Real-time UTXO event streams over WebSockets
slug: docs/litecoin/utxo-websockets
---
