---
title: eth_subscribe
description: Subscribe to different Arbitrum event types like newHeads, logs, pendingTransactions, and syncing using WebSockets.
subtitle: Subscribe to different Arbitrum event types like newHeads, logs, pendingTransactions, and syncing using WebSockets.
slug: reference/eth-subscribe-arbitrum
---
...
<CodeGroup>
  ...
  const client = createPublicClient({
    chain: arbitrum,
    transport: webSocket('wss://arb-mainnet.g.alchemy.com/v2/demo') // Replace with your API key
  })
  // Subscribe to new blocks on Arbitrum
