...
<Warning title="Degen Mainnet deprecation">
  Degen Chain is shutting down. Alchemy support for **Degen Mainnet** (`degen-mainnet`) ends on **August 31, 2026**. See the [Degen Mainnet Deprecation Notice](/docs/reference/degen-deprecation-notice) for details.
</Warning>
