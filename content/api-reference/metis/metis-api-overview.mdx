...
| [`eth_getUncleCountByBlockNumber`](/docs/chains/metis/metis-api-endpoints/eth-get-uncle-count-by-block-number) | [`eth_maxPriorityFeePerGas`](/docs/chains/metis/metis-api-endpoints/eth-max-priority-fee-per-gas) |
