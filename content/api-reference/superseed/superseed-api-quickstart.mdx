...
The Superseed API lets you interact with the Superseed blockchain using standard JSON-RPC methods. You can retrieve block and transaction data, send transactions, and build applications powered by Superseed's high-throughput, EVM-compatible environment.

If you've worked with Ethereum's JSON-RPC APIs, you'll find the Superseed API interface familiar.
