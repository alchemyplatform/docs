...
The World Mobile Chain API provides interaction with the World Mobile Chain network through a set of JSON-RPC methods. If you've worked with Ethereum's JSON-RPC APIs, you'll find the interface familiar.
