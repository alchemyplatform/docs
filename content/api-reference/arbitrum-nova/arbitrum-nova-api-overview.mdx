...
|                                                                                                 |                                                                                             |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [`eth_accounts`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-accounts)           | [`eth_blobBaseFee`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-blob-base-fee) |
...
| [`eth_fillTransaction`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-fill-transaction) | [`eth_gasPrice`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-gas-price)      |
| [`eth_getAccount`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-account)      | [`eth_getBalance`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-balance)  |
| [`eth_getBlockByHash`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-block-by-hash) | [`eth_getBlockByNumber`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-block-by-number) |
| [`eth_getBlockReceipts`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-block-receipts) | [`eth_getBlockTransactionCountByHash`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-block-transaction-count-by-hash) |
...
| [`eth_getTransactionReceipt`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-transaction-receipt) | [`eth_getUncleByBlockHashAndIndex`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-uncle-by-block-hash-and-index) |
| [`eth_getUncleByBlockNumberAndIndex`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-uncle-by-block-number-and-index) | [`eth_getUncleCountByBlockHash`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-uncle-count-by-block-hash) |
| [`eth_getUncleCountByBlockNumber`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-get-uncle-count-by-block-number) | [`eth_maxPriorityFeePerGas`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-max-priority-fee-per-gas) |
...
| [`eth_subscribe`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-subscribe)         | [`eth_syncing`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-syncing)         |
| [`eth_uninstallFilter`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-uninstall-filter) | [`eth_unsubscribe`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/eth-unsubscribe) |
| [`net_listening`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/net-listening)         | [`net_version`](/docs/chains/arbitrum-nova/arbitrum-nova-api-endpoints/net-version)         |
