...
Well done! You've just made your first request to the Tron API. With this foundation, you can dive deeper into the array of [HTTP JSON endpoints available on Tron API](/reference/tron-api-endpoints) and start building your dApps on it!
