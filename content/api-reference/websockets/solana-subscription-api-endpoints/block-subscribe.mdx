...
<Warning>
  Solana marks `blockSubscribe` as an **unstable** RPC PubSub subscription. The format of this subscription may change in the future. See the [Solana docs](https://solana.com/docs/rpc/websocket/blocksubscribe) for details.
</Warning>
