...
Explained in [Avalanche P-Chain API Quickstart](/reference/avalanche-p-api-quickstart).

## Is the Avalanche P-Chain EVM compatible?

No. The Avalanche P-Chain is not EVM compatible. It uses the `platform.*` JSON-RPC namespace. For EVM-compatible smart contracts and dApps, use the [Avalanche C-Chain](/reference/avalanche-api-quickstart).
