...
description: Set up your first Alchemy webhook to receive real-time notifications for onchain events.
subtitle: Fast, consistent, and custom push notifications!
slug: reference/notify-api-quickstart
---

# How to Set Up Alchemy Webhooks
...
2. Determine which [type of webhook](/docs/reference/notify-api-quickstart#types-of-webhooks) you want to activate.
...
Use the `create-webhook` endpoint: [/docs/data/webhooks/webhooks-api-endpoints/notify-api-endpoints/create-webhook](/docs/data/webhooks/webhooks-api-endpoints/notify-api-endpoints/create-webhook).
...
* Best-effort FIFO for first-time delivery — all first-time webhook notifications, regardless of the selected chain or network speed, are delivered in order
