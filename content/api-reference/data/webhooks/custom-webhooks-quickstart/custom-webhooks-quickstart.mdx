...
Setting up a Custom Webhook is as simple as defining a filter and adding a new URL to your application. If you're not familiar with the Alchemy Notify offering, note that Custom Webhooks is just [one of many different Notify API types](/docs/reference/webhook-types)!
...
For more information on setting up Custom Webhooks via the Alchemy Notify Dashboard, please refer to: [Custom Webhooks Dashboard Guide](/docs/reference/custom-webhook#how-to-set-up-custom-webhooks)
...
| -------------------------------------------------- |
| [Create webhook](/docs/data/webhooks/webhooks-api-endpoints/notify-api-endpoints/create-webhook)        |
| [Get all webhooks](/docs/data/webhooks/webhooks-api-endpoints/notify-api-endpoints/team-webhooks)       |
| [Delete webhook](/docs/data/webhooks/webhooks-api-endpoints/notify-api-endpoints/delete-webhook)        |
| [Update webhook status](/docs/data/webhooks/webhooks-api-endpoints/notify-api-endpoints/update-webhook) |
