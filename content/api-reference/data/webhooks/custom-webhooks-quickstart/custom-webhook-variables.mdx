...
`Address` typed variables can be used in either \[external transaction filters]\(External Transaction Filters) and/or [internal transaction filters](/docs/reference/custom-webhook-filters#internal-transaction-debug-trace-calls-filters).
