---
title: eth_subscribe
description: Subscribe to different Astar event types like newHeads, logs using WebSockets.
subtitle: Subscribe to different Astar event types like newHeads, logs using WebSockets.
slug: reference/eth-subscribe-astar
---
...
<CodeGroup>
  ...
  const client = createPublicClient({
    chain: {
      ...
      name: 'Astar',
      rpcUrls: {
        default: { http: ['https://astar-mainnet.g.alchemy.com/v2/demo'] },
        webSocket: { ws: ['wss://astar-mainnet.g.alchemy.com/v2/demo'] }
      }
    },
    transport: webSocket('wss://astar-mainnet.g.alchemy.com/v2/demo') // Replace with your API key
  })

  // Subscribe to new blocks on Astar
