...
|                                                                                                 |                                                                                             |
| ----------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------- |
| [`debug_executionWitness`](/docs/chains/unichain/unichain-api-endpoints/debug-execution-witness) | [`eth_blockNumber`](/docs/chains/unichain/unichain-api-endpoints/eth-block-number)          |
| [`eth_call`](/docs/chains/unichain/unichain-api-endpoints/eth-call)                             | [`eth_callMany`](/docs/chains/unichain/unichain-api-endpoints/eth-call-many)                |
| [`eth_chainId`](/docs/chains/unichain/unichain-api-endpoints/eth-chain-id)                      | [`eth_estimateGas`](/docs/chains/unichain/unichain-api-endpoints/eth-estimate-gas)          |
